 ...
 * @generated
 */
public class CheckerPackageImpl extends EPackageImpl implements CheckerPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.kermeta.language.checker.CheckerPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private CheckerPackageImpl() {
		super(eNS_URI, CheckerFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link CheckerPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static CheckerPackage init() {
		if (isInited)
			return (CheckerPackage) EPackage.Registry.INSTANCE
		...
		CheckerPackageImpl theCheckerPackage = (CheckerPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof CheckerPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI)
				: new CheckerPackageImpl());
		...
		theCheckerPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(CheckerPackage.eNS_URI,
				theCheckerPackage);
		return theCheckerPackage;
	}
	...
	public CheckerFactory getCheckerFactory() {
		return (CheckerFactory) getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		checkerEClass.getESuperTypes().add(theStructurePackage.getObject());

		// Initialize classes and features; add operations and parameters
		initEClass(checkerEClass, Checker.class, "Checker", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		EOperation op = addEOperation(checkerEClass, null, "check", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theStructurePackage.getModelingUnit(), "mu", 0, 1,
				IS_UNIQUE, IS_ORDERED);
	...
	protected void createKermetaAnnotations() {
		...
		addAnnotation(this, source, new String[] { "ecoreUri",
				"http://www.kermeta.org/org/kermeta/language/checker" });
	}
