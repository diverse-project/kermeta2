...
public class StructureSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case StructurePackage.PROPERTY_CONSTRAINT: {
			PropertyConstraint propertyConstraint = (PropertyConstraint) theEObject;
			T result = casePropertyConstraint(propertyConstraint);
			if (result == null)
				result = caseConstraint(propertyConstraint);
			if (result == null)
				result = caseNamedElement(propertyConstraint);
			if (result == null)
				result = caseObject(propertyConstraint);
			if (result == null)
