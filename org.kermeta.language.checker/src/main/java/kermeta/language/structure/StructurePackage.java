...
public interface StructurePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int OBJECT__INTERNAL_CONTAINING_RESOURCE = 3;
	...
	/**
	 * The feature id for the '<em><b>Get Violated Constraints Must Drill Down Cache</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 ...
	 * @ordered
	 */
	int PROPERTY__IS_GETTER_ABSTRACT = MULTIPLICITY_ELEMENT_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int PROPERTY__DEFAULT = MULTIPLICITY_ELEMENT_FEATURE_COUNT + 9;
	 ...
	 * @ordered
	 */
	int PROPERTY__IS_READ_ONLY = MULTIPLICITY_ELEMENT_FEATURE_COUNT + 10;
	 ...
	 * @ordered
	 */
	int PROPERTY__PROPERTY_CONSTRAINT = MULTIPLICITY_ELEMENT_FEATURE_COUNT + 11;
	 ...
	 * @ordered
	 */
	int PROPERTY__IS_ID = MULTIPLICITY_ELEMENT_FEATURE_COUNT + 12;
	 ...
	 * @ordered
	 */
	int PROPERTY_FEATURE_COUNT = MULTIPLICITY_ELEMENT_FEATURE_COUNT + 13;
	 ...
	 * @generated
	 */
	int GENERIC_TYPE_DEFINITION = 21;
	 ...
	 * @ordered
	 */
	int CLASS_DEFINITION__INTERNAL_CONTAINING_RESOURCE = GENERIC_TYPE_DEFINITION__INTERNAL_CONTAINING_RESOURCE;
	...
	/**
	 * The feature id for the '<em><b>all Attribute Cache</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CLASS_DEFINITION__ALL_ATTRIBUTE_CACHE = GENERIC_TYPE_DEFINITION_FEATURE_COUNT + 2;
	...
	/**
	 * The feature id for the '<em><b>all Super Types Cache</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CLASS_DEFINITION__ALL_SUPER_TYPES_CACHE = GENERIC_TYPE_DEFINITION_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int CLASS_DEFINITION__INV = GENERIC_TYPE_DEFINITION_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int ENUMERATION_LITERAL__OID = NAMED_ELEMENT__OID;
	 ...
	 * @ordered
	 */
	int ENUMERATION_LITERAL__INTERNAL_CONTAINING_RESOURCE = NAMED_ELEMENT__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int CLASS__OID = PARAMETERIZED_TYPE__OID;
	 ...
	 * @ordered
	 */
	int CLASS__INTERNAL_CONTAINING_RESOURCE = PARAMETERIZED_TYPE__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int CLASS_FEATURE_COUNT = PARAMETERIZED_TYPE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PACKAGE__OID = NAMED_ELEMENT__OID;
	 ...
	 * @ordered
	 */
	int PACKAGE__INTERNAL_CONTAINING_RESOURCE = NAMED_ELEMENT__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int PARAMETER__INTERNAL_CONTAINING_RESOURCE = MULTIPLICITY_ELEMENT__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int TAG__INTERNAL_CONTAINING_RESOURCE = OBJECT__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int MODELING_UNIT__OID = OBJECT__OID;
	 ...
	 * @ordered
	 */
	int MODELING_UNIT__INTERNAL_CONTAINING_RESOURCE = OBJECT__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @generated
	 */
	int KERMETA_PROPERTY_OBJECT_OID = 43;
	...
	/**
	 * Returns the meta object for the container reference '{@link kermeta.language.structure.PropertyConstraint#getProperty <em>Property</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link kermeta.language.structure.Property#getGetViolatedConstraintsMustDrillDownCache <em>Get Violated Constraints Must Drill Down Cache</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Get Violated Constraints Must Drill Down Cache</em>'.
	 * @see kermeta.language.structure.Property#getGetViolatedConstraintsMustDrillDownCache()
	 * @see #getProperty()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference '{@link kermeta.language.structure.Property#getPropertyConstraint <em>Property Constraint</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Property Constraint</em>'.
	 * @see kermeta.language.structure.Property#getPropertyConstraint()
	 * @see #getProperty()
	 * @generated
	 */
	EReference getProperty_PropertyConstraint();
	...
	/**
	 * Returns the meta object for the reference '{@link kermeta.language.structure.ClassDefinition#get_allAttributeCache <em>all Attribute Cache</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>all Attribute Cache</em>'.
	 * @see kermeta.language.structure.ClassDefinition#get_allAttributeCache()
	 * @see #getClassDefinition()
	 * @generated
	 */
	EReference getClassDefinition__allAttributeCache();
	...
	/**
	 * Returns the meta object for the reference '{@link kermeta.language.structure.ClassDefinition#get_allSuperTypesCache <em>all Super Types Cache</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>all Super Types Cache</em>'.
	 * @see kermeta.language.structure.ClassDefinition#get_allSuperTypesCache()
	 * @see #getClassDefinition()
	 * @generated
	 */
	EReference getClassDefinition__allSuperTypesCache();
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link kermeta.language.structure.impl.PropertyConstraintImpl <em>Property Constraint</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see kermeta.language.structure.impl.PropertyConstraintImpl
		 * @see kermeta.language.structure.impl.StructurePackageImpl#getPropertyConstraint()
		 ...
		 * @generated
		 */
		EReference PROPERTY_CONSTRAINT__PROPERTY = eINSTANCE
		...
		/**
		 * The meta object literal for the '<em><b>Get Violated Constraints Must Drill Down Cache</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute PROPERTY__GET_VIOLATED_CONSTRAINTS_MUST_DRILL_DOWN_CACHE = eINSTANCE
		 ...
		 * @generated
		 */
		EReference PROPERTY__PROPERTY_CONSTRAINT = eINSTANCE
				.getProperty_PropertyConstraint();
		...
		/**
		 * The meta object literal for the '<em><b>all Attribute Cache</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference CLASS_DEFINITION__ALL_ATTRIBUTE_CACHE = eINSTANCE
				.getClassDefinition__allAttributeCache();
		...
		/**
		 * The meta object literal for the '<em><b>all Super Types Cache</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference CLASS_DEFINITION__ALL_SUPER_TYPES_CACHE = eINSTANCE
				.getClassDefinition__allSuperTypesCache();
		...
		/**
		 * The meta object literal for the '<em><b>Internal Containing Resource</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference OBJECT__INTERNAL_CONTAINING_RESOURCE = eINSTANCE
				.getObject_InternalContainingResource();
