...
public class StructurePackageImpl extends EPackageImpl implements
	 ...
	 * @generated
	 */
	public EAttribute getProperty_GetViolatedConstraintsMustDrillDownCache() {
	 ...
	 * @generated
	 */
	public EReference getProperty_PropertyConstraint() {
	 ...
	 * @generated
	 */
	public EReference getClassDefinition__allAttributeCache() {
		return (EReference) classDefinitionEClass.getEStructuralFeatures().get(
				1);
	}
	 ...
	 * @generated
	 */
	public EReference getClassDefinition__allSuperTypesCache() {
		return (EReference) classDefinitionEClass.getEStructuralFeatures().get(
				3);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(propertyEClass,
				PROPERTY__GET_VIOLATED_CONSTRAINTS_MUST_DRILL_DOWN_CACHE);
		...
		createEReference(propertyEClass, PROPERTY__PROPERTY_CONSTRAINT);
		...
		createEReference(classDefinitionEClass,
				CLASS_DEFINITION__ALL_ATTRIBUTE_CACHE);
		createEAttribute(classDefinitionEClass, CLASS_DEFINITION__IS_ABSTRACT);
		createEReference(classDefinitionEClass,
				CLASS_DEFINITION__ALL_SUPER_TYPES_CACHE);
	...
	public void initializePackageContents() {
		...
		initEReference(getPropertyConstraint_Property(), this.getProperty(),
				this.getProperty_PropertyConstraint(), "property", null, 0, 1,
				PropertyConstraint.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(propertyEClass, Property.class, "Property", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getProperty_GetViolatedConstraintsMustDrillDownCache(),
				theStandardPackage.getJavaBoolean(),
				"getViolatedConstraintsMustDrillDownCache", "false", 0, 1,
		...
		initEAttribute(getProperty_IsReadOnly(), theStandardPackage
				...
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProperty_PropertyConstraint(), this
				.getPropertyConstraint(),
				this.getPropertyConstraint_Property(), "propertyConstraint",
		...
		addEOperation(propertyEClass, theStandardPackage.getJavaBoolean(),
				"getViolatedConstraintsMustDrillDown", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		...
		initEReference(getClassDefinition__allAttributeCache(), g1, null,
				"_allAttributeCache", null, 0, 1, ClassDefinition.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		g1.getETypeArguments().add(g2);
		initEReference(getClassDefinition__allSuperTypesCache(), g1, null,
				"_allSuperTypesCache", null, 0, 1, ClassDefinition.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		EOperation op = addEOperation(classDefinitionEClass, null,
				"getCachedAllAttribute", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(theStandardPackage.getSet());
		...
		op = addEOperation(classDefinitionEClass, null,
				"getCachedAllSuperTypes", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(theStandardPackage.getSet());
		g2 = createEGenericType(this.getType());
		g1.getETypeArguments().add(g2);
		initEOperation(op, g1);
	...
	protected void createKermetaAnnotations() {
		...
		addAnnotation(
				classDefinitionEClass.getEOperations().get(1),
				source,
				new String[] {
						"documentation",
						"/**\n\t * returns a cached version of the derived property allSuperTypes\n\t * It is intended to be used to optimize access on the reflexivity, \n\t * do not use this cache if you are modifying the ClassDefinition\n\t */" });
		addAnnotation(
				classDefinitionEClass.getEOperations().get(2),
				source,
				new String[] {
						"documentation",
		...
		addAnnotation(classEClass.getEOperations().get(1), source,
				new String[] { "superOperation",
						"kermeta::language::structure::Type" });
		addAnnotation(
				classEClass.getEOperations().get(2),
				source,
				new String[] { "documentation",
		...
		addAnnotation(
				...
				new String[] { "documentation",
						"/**\n\t * To be written ##########################################\n\t */" });
		addAnnotation(modelTypeEClass.getEOperations().get(0), source,
				new String[] { "CompilerIgnore", "true" });
		addAnnotation(
				...
				new String[] { "documentation",
						"/**\n\t * To be written ##########################################\n\t */" });
		addAnnotation(modelTypeEClass.getEOperations().get(1), source,
				new String[] { "CompilerIgnore", "true" });
		...
		addAnnotation(modelEClass.getEOperations().get(3), source,
				new String[] { "CompilerIgnore", "true" });
		addAnnotation(
	...
	protected void createKermeta_1Annotations() {
		...
		addAnnotation(packageEClass, source,
				new String[] { "no_underscore", "" });
		addAnnotation(functionTypeEClass, source, new String[] {
