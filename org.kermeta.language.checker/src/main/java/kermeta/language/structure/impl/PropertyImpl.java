 ...
 *   <li>{@link kermeta.language.structure.impl.PropertyImpl#getPropertyConstraint <em>Property Constraint</em>}</li>
...
public class PropertyImpl extends MultiplicityElementImpl implements Property {
	/**
	 * The default value of the '{@link #getGetViolatedConstraintsMustDrillDownCache() <em>Get Violated Constraints Must Drill Down Cache</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getGetViolatedConstraintsMustDrillDownCache()
	 * @generated
	 * @ordered
	 */
	protected static final Boolean GET_VIOLATED_CONSTRAINTS_MUST_DRILL_DOWN_CACHE_EDEFAULT = Boolean.FALSE;

	/**
	 * The cached value of the '{@link #getGetViolatedConstraintsMustDrillDownCache() <em>Get Violated Constraints Must Drill Down Cache</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getGetViolatedConstraintsMustDrillDownCache()
	 * @generated
	 ...
	 * @generated
	 */
	public Boolean getGetViolatedConstraintsMustDrillDownCache() {
		return getViolatedConstraintsMustDrillDownCache;
	}
	 ...
	 * @generated
	 */
	public void setGetViolatedConstraintsMustDrillDownCache(
			Boolean newGetViolatedConstraintsMustDrillDownCache) {
		Boolean oldGetViolatedConstraintsMustDrillDownCache = getViolatedConstraintsMustDrillDownCache;
		getViolatedConstraintsMustDrillDownCache = newGetViolatedConstraintsMustDrillDownCache;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					StructurePackage.PROPERTY__GET_VIOLATED_CONSTRAINTS_MUST_DRILL_DOWN_CACHE,
					oldGetViolatedConstraintsMustDrillDownCache,
					getViolatedConstraintsMustDrillDownCache));
	}
	...
	public PropertyConstraint getPropertyConstraint() {
		if (propertyConstraint != null && propertyConstraint.eIsProxy()) {
			InternalEObject oldPropertyConstraint = (InternalEObject) propertyConstraint;
			propertyConstraint = (PropertyConstraint) eResolveProxy(oldPropertyConstraint);
			if (propertyConstraint != oldPropertyConstraint) {
				InternalEObject newPropertyConstraint = (InternalEObject) propertyConstraint;
				NotificationChain msgs = oldPropertyConstraint.eInverseRemove(
						this, StructurePackage.PROPERTY_CONSTRAINT__PROPERTY,
						PropertyConstraint.class, null);
				if (newPropertyConstraint.eInternalContainer() == null) {
					msgs = newPropertyConstraint.eInverseAdd(this,
							StructurePackage.PROPERTY_CONSTRAINT__PROPERTY,
							PropertyConstraint.class, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							...
							oldPropertyConstraint, propertyConstraint));
			}
		}
	 ...
	 * @generated
	 */
	public PropertyConstraint basicGetPropertyConstraint() {
		return propertyConstraint;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPropertyConstraint(
			PropertyConstraint newPropertyConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					StructurePackage.PROPERTY__PROPERTY_CONSTRAINT,
					oldPropertyConstraint, newPropertyConstraint);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setPropertyConstraint(PropertyConstraint newPropertyConstraint) {
		if (newPropertyConstraint != propertyConstraint) {
			...
			if (propertyConstraint != null)
				msgs = ((InternalEObject) propertyConstraint).eInverseRemove(
						this, StructurePackage.PROPERTY_CONSTRAINT__PROPERTY,
						PropertyConstraint.class, msgs);
			if (newPropertyConstraint != null)
				msgs = ((InternalEObject) newPropertyConstraint).eInverseAdd(
						this, StructurePackage.PROPERTY_CONSTRAINT__PROPERTY,
						PropertyConstraint.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					StructurePackage.PROPERTY__PROPERTY_CONSTRAINT,
					newPropertyConstraint, newPropertyConstraint));
	}
	 ...
	 * @generated
	 */
	public Boolean getViolatedConstraintsMustDrillDown() {
		...
		if (idIfCond_332) {
			...
			this
					.setGetViolatedConstraintsMustDrillDownCache(kermeta.standard.helper.BooleanWrapper
							.not(org.kermeta.compil.runtime.helper.language.TypeUtil
									.isSuperTypeOfSwitcher(
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case StructurePackage.PROPERTY__PROPERTY_CONSTRAINT:
			if (propertyConstraint != null)
				msgs = ((InternalEObject) propertyConstraint)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- StructurePackage.PROPERTY__PROPERTY_CONSTRAINT,
								null, msgs);
			return basicSetPropertyConstraint((PropertyConstraint) otherEnd,
					msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case StructurePackage.PROPERTY__PROPERTY_CONSTRAINT:
			...
			return basicGetPropertyConstraint();
	...
	public String toString() {
		...
		result.append(" (getViolatedConstraintsMustDrillDownCache: ");
		result.append(getViolatedConstraintsMustDrillDownCache);
