...
public class XmltypeFactoryImpl extends EFactoryImpl implements XmltypeFactory {
	...
	public static XmltypeFactory init() {
		try {
			XmltypeFactory theXmltypeFactory = (XmltypeFactory) EPackage.Registry.INSTANCE
					.getEFactory("http://www.kermeta.org/kermeta/1_2_0//kermeta/xmltype/kermeta_temp_uri");
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case XmltypePackage.JAVA_QNAME:
			return createJavaQNameFromString(eDataType, initialValue);
		default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
		case XmltypePackage.JAVA_QNAME:
			return convertJavaQNameToString(eDataType, instanceValue);
		default:
			throw new IllegalArgumentException("The datatype '"
					+ eDataType.getName() + "' is not a valid classifier");
		}
	 ...
	 * @generated
	 */
	public String createJavaQNameFromString(EDataType eDataType,
			String initialValue) {
	 ...
	 * @generated
	 */
	public String convertJavaQNameToString(EDataType eDataType,
