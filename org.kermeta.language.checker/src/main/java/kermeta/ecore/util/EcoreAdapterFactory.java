...
public class EcoreAdapterFactory extends AdapterFactoryImpl {
	...
	protected EcoreSwitch<Adapter> modelSwitch = new EcoreSwitch<Adapter>() {
		@Override
		public Adapter caseEFeatureMapEntry(EFeatureMapEntry object) {
			return createEFeatureMapEntryAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link kermeta.ecore.EFeatureMapEntry <em>EFeature Map Entry</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEFeatureMapEntryAdapter() {
		return null;
	}
