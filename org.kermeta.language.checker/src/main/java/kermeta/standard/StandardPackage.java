...
public interface StandardPackage extends EPackage {
	 ...
	 * @generated
	 */
	int NOT_COMPARABLE_EXCEPTION = 7;
	...
	/**
	 * The meta object id for the '{@link kermeta.standard.impl.EachContextImpl <em>Each Context</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see kermeta.standard.impl.EachContextImpl
	 * @see kermeta.standard.impl.StandardPackageImpl#getEachContext()
	 * @generated
	 */
	int EACH_CONTEXT = 13;
	 ...
	 * @ordered
	 */
	int EACH_CONTEXT__TAG = StructurePackage.OBJECT__TAG;
	 ...
	 * @ordered
	 */
	int EACH_CONTEXT__OWNED_TAGS = StructurePackage.OBJECT__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int EACH_CONTEXT__OID = StructurePackage.OBJECT__OID;
	 ...
	 * @ordered
	 */
	int EACH_CONTEXT__INTERNAL_CONTAINING_RESOURCE = StructurePackage.OBJECT__INTERNAL_CONTAINING_RESOURCE;
	 ...
	 * @ordered
	 */
	int EACH_CONTEXT__IS_LAST = StructurePackage.OBJECT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int EACH_CONTEXT__INDEX = StructurePackage.OBJECT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int EACH_CONTEXT__IS_FIRST = StructurePackage.OBJECT_FEATURE_COUNT + 2;

	/**
	 * The number of structural features of the '<em>Each Context</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int EACH_CONTEXT_FEATURE_COUNT = StructurePackage.OBJECT_FEATURE_COUNT + 3;
	 ...
	 * @generated
	 */
	int KERMETA_PROPERTY_COLLECTION_VALUES = 27;
	 ...
	 * @generated
	 */
	int KERMETA_PROPERTY_ITERATOR_JAVA_ITERATOR = 28;
	 ...
	 * @generated
	 */
	int KERMETA_PROPERTY_VALUE_TYPE_VALUE = 29;
	...
	/**
	 * Returns the meta object for class '{@link kermeta.standard.EachContext <em>Each Context</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Each Context</em>'.
	 * @see kermeta.standard.EachContext
	 * @generated
	 */
	EClass getEachContext();

	/**
	 * Returns the meta object for the attribute '{@link kermeta.standard.EachContext#getIsLast <em>Is Last</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Is Last</em>'.
	 * @see kermeta.standard.EachContext#getIsLast()
	 * @see #getEachContext()
	 * @generated
	 */
	EAttribute getEachContext_IsLast();

	/**
	 * Returns the meta object for the attribute '{@link kermeta.standard.EachContext#getIndex <em>Index</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Index</em>'.
	 * @see kermeta.standard.EachContext#getIndex()
	 * @see #getEachContext()
	 * @generated
	 */
	EAttribute getEachContext_Index();

	/**
	 * Returns the meta object for the attribute '{@link kermeta.standard.EachContext#getIsFirst <em>Is First</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Is First</em>'.
	 * @see kermeta.standard.EachContext#getIsFirst()
	 * @see #getEachContext()
	 * @generated
	 */
	EAttribute getEachContext_IsFirst();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link kermeta.standard.impl.EachContextImpl <em>Each Context</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see kermeta.standard.impl.EachContextImpl
		 * @see kermeta.standard.impl.StandardPackageImpl#getEachContext()
		 * @generated
		 */
		EClass EACH_CONTEXT = eINSTANCE.getEachContext();
		 ...
		 * @generated
		 */
		EAttribute EACH_CONTEXT__IS_LAST = eINSTANCE.getEachContext_IsLast();
		 ...
		 * @generated
		 */
		EAttribute EACH_CONTEXT__INDEX = eINSTANCE.getEachContext_Index();
		 ...
		 * @generated
		 */
		EAttribute EACH_CONTEXT__IS_FIRST = eINSTANCE.getEachContext_IsFirst();
