...
public class InterpreterSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case InterpreterPackage.DYNAMIC_EXPRESSION: {
			...
			if (result == null)
				result = caseObject(dynamicExpression);
			if (result == null)
		...
		case InterpreterPackage.KERMETA_ERROR: {
			...
			if (result == null)
				result = caseObject(kermetaError);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case InterpreterPackage.PARSE_ERROR: {
			...
			if (result == null)
				result = caseKermetaError(parseError);
			if (result == null)
				result = caseObject(parseError);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case InterpreterPackage.TYPE_ERROR: {
			...
			if (result == null)
				result = caseKermetaError(typeError);
			if (result == null)
				result = caseObject(typeError);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
