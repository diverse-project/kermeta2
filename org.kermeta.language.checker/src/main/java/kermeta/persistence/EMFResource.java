...
public interface EMFResource extends Resource {
	 ...
	 *        annotation="kermeta superOperation='kermeta::standard::Set'"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\n\t//BIft:select\n\nkermeta.standard.Sequence<kermeta.persistence.Resource> result_ft73 = null;\n\n\tkermeta.persistence.Resource elem_ft73 = null;\n\n\tresult_ft73 = ((kermeta.standard.Sequence<kermeta.persistence.Resource>) org.kermeta.compil.runtime.helper.language.ClassUtil.newObject(kermeta.standard.StandardPackage.eINSTANCE.getSequence()));\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.persistence.Resource> it_ft73 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil.<kermeta.persistence.Resource>convertAsSet(this.getRepository().getResources()).iterator();\n\tjava.lang.Boolean idLoopCond_307 = false;\n\twhile( !idLoopCond_307 ) {\n\tidLoopCond_307 = it_ft73.isOff();\n\tif ( idLoopCond_307 ) {\n\t} else {\n\n\telem_ft73 = it_ft73.next();\n\n\tjava.lang.Boolean idIfCond_308 = false;\n//BIle:selector\nkermeta.persistence.Resource r_lbdExp73 = elem_ft73;\n\n\tidIfCond_308 = kermeta.standard.helper.BooleanWrapper.and(org.kermeta.compil.runtime.helper.language.ObjectUtil.isNotEqualSwitcher(r_lbdExp73, this), r_lbdExp73.contains(instance));\n//EIle:selector\n\n\n\tif( idIfCond_308 ) {\n\n\tresult_ft73.add(elem_ft73);\n}\n\n}\n\t}\n}\n\n//EIft:select\n//BIft:each\n\n\t\n{\n\n\tkermeta.standard.Iterator<kermeta.persistence.Resource> it_ft72 = result_ft73.iterator();\n\tjava.lang.Boolean idLoopCond_306 = false;\n\twhile( !idLoopCond_306 ) {\n\tidLoopCond_306 = it_ft72.isOff();\n\tif ( idLoopCond_306 ) {\n\t} else {\n\n\t//BIle:func\nkermeta.persistence.Resource r_lbdExp72 = it_ft72.next();\n\n\torg.kermeta.compil.runtime.helper.io.StdIOUtil.getInstance().writeln(\"DVK ! another resource of the same repository was containing this element\");\n\n\tr_lbdExp72.remove(instance);\n//EIle:func\n\n}\n\t}\n}\n\n//EIft:each\n\n\n\torg.kermeta.compil.runtime.helper.language.ObjectUtil.setContainingResource(instance, this);\n\n\tkermeta.standard.helper.SetSuper.super_add(this, instance);\n'"
	 * @generated
	 */
