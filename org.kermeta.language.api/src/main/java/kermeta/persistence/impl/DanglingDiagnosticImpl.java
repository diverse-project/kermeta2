 ...
 * @generated
 */
public class DanglingDiagnosticImpl extends ObjectImpl implements
		DanglingDiagnostic {
	/**
			...
			if (referencingElement != oldReferencingElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							PersistencePackage.DANGLING_DIAGNOSTIC__REFERENCING_ELEMENT,
							oldReferencingElement, referencingElement));
			}
		}
	 ...
	 * @generated
	 */
	public void setReferencingElement(
			kermeta.language.structure.Object newReferencingElement) {
			...
			if (danglingElement != oldDanglingElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							PersistencePackage.DANGLING_DIAGNOSTIC__DANGLING_ELEMENT,
							oldDanglingElement, danglingElement));
			}
		}
	 ...
	 * @generated
	 */
	public void setDanglingElement(
			kermeta.language.structure.Object newDanglingElement) {
			...
			if (referencingProperty != oldReferencingProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							PersistencePackage.DANGLING_DIAGNOSTIC__REFERENCING_PROPERTY,
							oldReferencingProperty, referencingProperty));
			}
		}
