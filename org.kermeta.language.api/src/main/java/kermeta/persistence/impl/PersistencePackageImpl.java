...
public class PersistencePackageImpl extends EPackageImpl implements
	...
	public static PersistencePackage init() {
		...
		PersistencePackageImpl thePersistencePackage = (PersistencePackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof PersistencePackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI)
	...
	protected void createKermetaAnnotations() {
		...
		addAnnotation(resourceEClass, source, new String[] { "CompilerIgnore",
				"true" });
		...
		addAnnotation(emfResourceEClass.getEOperations().get(3), source,
				new String[] { "superOperation",
						"kermeta::persistence::Resource" });
		addAnnotation(
		...
		addAnnotation(emfResourceEClass.getEOperations().get(6), source,
				new String[] { "superOperation",
						"kermeta::persistence::Resource" });
		addAnnotation(
				emfResourceEClass.getEOperations().get(7),
				source,
				new String[] {
						"documentation",
		...
		addAnnotation(emfResourceEClass.getEOperations().get(7), source,
				new String[] { "superOperation", "kermeta::standard::Set" });
		addAnnotation(
				repositoryEClass,
				source,
		...
		addAnnotation(repositoryEClass, source, new String[] {
				"CompilerIgnore", "true" });
		...
		addAnnotation(danglingDiagnosticEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(
		...
		addAnnotation(emfRepositoryEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(
