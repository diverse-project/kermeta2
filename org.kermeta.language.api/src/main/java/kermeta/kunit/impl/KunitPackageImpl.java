...
public class KunitPackageImpl extends EPackageImpl implements KunitPackage {
	...
	protected void createKermetaAnnotations() {
		...
		addAnnotation(invalidTestCaseNameExceptionEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(
		...
		addAnnotation(invalidParameterExceptionEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(
				fallibleEClass,
				source,
		...
		addAnnotation(fallibleEClass, source, new String[] { "CompilerIgnore",
				"true" });
		addAnnotation(
		...
		addAnnotation(logEClass, source, new String[] { "CompilerIgnore",
				"true" });
		addAnnotation(
		...
		addAnnotation(failureEClass, source, new String[] { "CompilerIgnore",
				"true" });
		addAnnotation(
		...
		addAnnotation(errorEClass, source, new String[] { "CompilerIgnore",
				"true" });
		addAnnotation(
		...
		addAnnotation(testEClass, source, new String[] { "CompilerIgnore",
				"true" });
		...
		addAnnotation(testSuiteEClass, source, new String[] { "CompilerIgnore",
				"true" });
		addAnnotation(
		...
		addAnnotation(testCaseEClass, source, new String[] { "CompilerIgnore",
				"true" });
		addAnnotation(
		...
		addAnnotation(testRunnerEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(
		...
		addAnnotation(assertionFailedErrorEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(assertEClass, source, new String[] { "CompilerIgnore",
				"true" });
