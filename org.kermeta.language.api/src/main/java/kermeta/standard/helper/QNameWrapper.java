...
public class QNameWrapper {
	...
	java.lang.String self, java.lang.String element
		...
		result = (java.lang.Boolean) org.kermeta.compil.runtime.helper.language.ObjectUtil
				.asTypeOrVoid(
						org.kermeta.compil.runtime.helper.language.ObjectUtil
								.equals(self, element), "java.lang.Boolean");
				...
				while (!idLoopCond_5) {
					...
					if (idLoopCond_5) {
...

						{
							...
							while (!idLoopCond_7) {
								idLoopCond_7 = kermeta.standard.helper.BooleanWrapper
										.or(
												it_ft3.isOff(),
												org.kermeta.compil.runtime.helper.language.ObjectUtil
														.isNotEqualSwitcher(
						...
						if (idIfCond_6) {
							...
							if (idIfCond_8) {
								...
								idIfCond_11 = kermeta.standard.helper.IntegerWrapper
	...
	java.lang.String self, java.lang.String other
		...
		if (self == null) {
			...
			exp.setMessage("Initialize the QName expression");
	 ...
	 * @generated
	 */
	public static <G> G plus(

	java.lang.String self, G other
