	...
	java.lang.Boolean self, kermeta.language.structure.Property property,
		...
		if (idIfCond_68) {
			...
			if (idIfCond_70) {
				...
				//BIle:right
				/*This variable should be never used*/kermeta.language.structure.Object e_lbdExp23 = null;

				result_ft23 = org.kermeta.compil.runtime.helper.language.ObjectUtil
	...
	java.lang.Boolean self
		...
		if (idIfCond_71) {
...

			{
				...
				while (!idLoopCond_72) {
					idLoopCond_72 = it_ft24.isOff();
					if (idLoopCond_72) {
					} else {

						//BIle:func
						kermeta.language.structure.Property p_lbdExp24 = it_ft24
								.next();
...

						{
							...
							kermeta.standard.Iterator<kermeta.language.structure.Tag> it_ft25 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
									.<kermeta.language.structure.Tag> convertAsOrderedSet(
											p_lbdExp24.getTag()).iterator();
							java.lang.Boolean idLoopCond_74 = false;
							while (!idLoopCond_74) {
								idLoopCond_74 = kermeta.standard.helper.BooleanWrapper
										.or(
												it_ft25.isOff(),
												org.kermeta.compil.runtime.helper.language.ObjectUtil
														.isNotEqualSwitcher(
								...
								if (idLoopCond_74) {
									...
									//BIle:func
									kermeta.language.structure.Tag t_lbdExp25 = it_ft25
											.next();

									result_lambda_ft25 = kermeta.standard.helper.StringWrapper
											.equals(t_lbdExp25.getName(),
													"ecore.isTransient");
									//EIle:func

									test_ft25 = kermeta.standard.helper.BooleanWrapper
											.or(test_ft25, result_lambda_ft25);
								}
							}
						}
						...
						idIfCond_73 = kermeta.standard.helper.BooleanWrapper
								.and(kermeta.standard.helper.BooleanWrapper
										.not(result_ft25),
										kermeta.standard.helper.BooleanWrapper
												.not(p_lbdExp24.getIsDerived()));

						if (idIfCond_73) {

							kermeta.language.structure.Object v = org.kermeta.compil.runtime.helper.language.ObjectUtil
									.getSwitcher(self, p_lbdExp24);
							...
							if (idIfCond_76) {
								...
								//BIle:right
								/*This variable should be never used*/kermeta.language.structure.Object f_lbdExp26 = null;

								result_ft26 = org.kermeta.compil.runtime.helper.language.ObjectUtil
							...
							if (idIfCond_75) {
								...
								idIfCond_78 = kermeta.standard.helper.IntegerWrapper
										.isLower(c.size(), p_lbdExp24
												.getLower());
