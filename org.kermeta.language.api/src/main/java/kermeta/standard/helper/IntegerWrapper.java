...
public class IntegerWrapper {
	...
	java.lang.Integer self, java.lang.Integer other
		...
		if (idIfCond_89) {
			...
			idIfCond_90 = org.kermeta.compil.runtime.helper.language.ClassUtil
					.equalsSwitcher(
							org.kermeta.compil.runtime.helper.language.ObjectUtil
									.getMetaClassSwitcher(other),
							org.kermeta.compil.runtime.ExecutionContext
	...
	java.lang.Integer self, java.lang.Integer other
		...
		idIfCond_96 = kermeta.standard.helper.IntegerWrapper.equals(other, 0);
	...
	java.lang.Integer self, java.lang.Integer other
		...
		idIfCond_98 = kermeta.standard.helper.IntegerWrapper.equals(other, 0);
	...
	java.lang.Integer self, java.lang.Integer other
		...
		if (idIfCond_100) {
			...
			idIfCond_101 = org.kermeta.compil.runtime.helper.language.ClassUtil
					.equalsSwitcher(
							org.kermeta.compil.runtime.helper.language.ObjectUtil
									.getMetaClassSwitcher(other),
							org.kermeta.compil.runtime.ExecutionContext
	...
	java.lang.Integer self, java.lang.Integer other
		...
		if (idIfCond_102) {
			...
			idIfCond_103 = org.kermeta.compil.runtime.helper.language.ClassUtil
					.equalsSwitcher(
							org.kermeta.compil.runtime.helper.language.ObjectUtil
									.getMetaClassSwitcher(other),
							org.kermeta.compil.runtime.ExecutionContext
	...
	java.lang.Integer self, java.lang.Integer other
		...
		if (idIfCond_104) {
			...
			idIfCond_105 = org.kermeta.compil.runtime.helper.language.ClassUtil
					.equalsSwitcher(
							org.kermeta.compil.runtime.helper.language.ObjectUtil
									.getMetaClassSwitcher(other),
							org.kermeta.compil.runtime.ExecutionContext
	...
	java.lang.Integer self, java.lang.Integer other
		...
		if (idIfCond_106) {
			...
			idIfCond_107 = org.kermeta.compil.runtime.helper.language.ClassUtil
					.equalsSwitcher(
							org.kermeta.compil.runtime.helper.language.ObjectUtil
									.getMetaClassSwitcher(other),
							org.kermeta.compil.runtime.ExecutionContext
	...
	java.lang.Integer self, kermeta.language.structure.Property property,
		...
		if (idIfCond_108) {
			...
			if (idIfCond_110) {
				...
				//BIle:right
				/*This variable should be never used*/kermeta.language.structure.Object e_lbdExp30 = null;
		...
		if (idIfCond_111) {
...

			{
				...
				while (!idLoopCond_112) {
					idLoopCond_112 = it_ft31.isOff();
					if (idLoopCond_112) {
					} else {

						//BIle:func
						kermeta.language.structure.Property p_lbdExp31 = it_ft31
								.next();
...

						{
							...
							kermeta.standard.Iterator<kermeta.language.structure.Tag> it_ft32 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
									.<kermeta.language.structure.Tag> convertAsOrderedSet(
											p_lbdExp31.getTag()).iterator();
							java.lang.Boolean idLoopCond_114 = false;
							while (!idLoopCond_114) {
								idLoopCond_114 = kermeta.standard.helper.BooleanWrapper
										.or(
												it_ft32.isOff(),
												org.kermeta.compil.runtime.helper.language.ObjectUtil
														.isNotEqualSwitcher(
								...
								if (idLoopCond_114) {
									...
									//BIle:func
									kermeta.language.structure.Tag t_lbdExp32 = it_ft32
											.next();

									result_lambda_ft32 = kermeta.standard.helper.StringWrapper
											.equals(t_lbdExp32.getName(),
													"ecore.isTransient");
									//EIle:func

									test_ft32 = kermeta.standard.helper.BooleanWrapper
											.or(test_ft32, result_lambda_ft32);
								}
							}
						}
						...
						idIfCond_113 = kermeta.standard.helper.BooleanWrapper
								.and(kermeta.standard.helper.BooleanWrapper
										...
										kermeta.standard.helper.BooleanWrapper
												.not(p_lbdExp31.getIsDerived()));

						if (idIfCond_113) {

							kermeta.language.structure.Object v = org.kermeta.compil.runtime.helper.language.ObjectUtil
									.getSwitcher(self, p_lbdExp31);
							...
							if (idIfCond_116) {
								...
								//BIle:right
								/*This variable should be never used*/kermeta.language.structure.Object f_lbdExp33 = null;

								result_ft33 = org.kermeta.compil.runtime.helper.language.ObjectUtil
							...
							if (idIfCond_115) {
								...
								idIfCond_118 = kermeta.standard.helper.IntegerWrapper
										.isLower(c.size(), p_lbdExp31
												.getLower());
	...
	java.lang.Integer self
		...
		if (idIfCond_121) {
...

			{
				...
				kermeta.standard.Iterator<kermeta.language.structure.Property> it_ft34 = org.kermeta.compil.runtime.helper.basetypes.CollectionUtil
						.<kermeta.language.structure.Property> convertAsSet(
								cd.getterAllAttribute()).iterator();
				java.lang.Boolean idLoopCond_122 = false;
				while (!idLoopCond_122) {
					idLoopCond_122 = it_ft34.isOff();
					if (idLoopCond_122) {
					} else {

						//BIle:func
						kermeta.language.structure.Property prop_lbdExp34 = it_ft34
								.next();

						java.lang.Boolean idIfCond_123 = false;
						idIfCond_123 = kermeta.standard.helper.BooleanWrapper
								.and(prop_lbdExp34.getIsComposite(),
										kermeta.standard.helper.BooleanWrapper
												.not(prop_lbdExp34
														.getIsDerived()));
						...
						if (idIfCond_123) {
							...
							if (idIfCond_124) {
...

								{
									...
									kermeta.standard.Iterator<kermeta.language.structure.Type> it_ft35 = ((kermeta.language.structure.ClassDefinition) org.kermeta.compil.runtime.helper.language.ObjectUtil
											.asTypeSwitcher(
													org.kermeta.compil.runtime.helper.language.ObjectUtil
									...
									while (!idLoopCond_126) {
										...
										if (idLoopCond_126) {
											...
											//BIle:func
											kermeta.language.structure.Type t_lbdExp35 = it_ft35
													.next();
											...
											if (idIfCond_127) {
												...
												result_lambda_ft35 = kermeta.standard.helper.StringWrapper
														.equals(
												...
												result_lambda_ft35 = false;
											}

											//EIle:func

											test_ft35 = kermeta.standard.helper.BooleanWrapper
													.or(test_ft35,
															result_lambda_ft35);
										}
									}
								...
								if (idIfCond_125) {
...

									{
										...
										kermeta.standard.Iterator<kermeta.language.structure.Object> it_ft36 = subObjInstances
												.iterator();
										java.lang.Boolean idLoopCond_128 = false;
										while (!idLoopCond_128) {
											idLoopCond_128 = it_ft36.isOff();
											if (idLoopCond_128) {
											} else {

												//BIle:func
												kermeta.language.structure.Object aSubObjInstances_lbdExp36 = it_ft36
														.next();

												org.kermeta.compil.runtime.helper.language.ObjectUtil
														.checkAllInvariantsSwitcher(aSubObjInstances_lbdExp36);
												//EIle:func
