...
public class StandardPackageImpl extends EPackageImpl implements
	 ...
	 * @generated
	 */
	private EClass eachContextEClass = null;
	 ...
	 * @generated
	 */
	public EClass getEachContext() {
		return eachContextEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getEachContext_IsLast() {
		return (EAttribute) eachContextEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getEachContext_Index() {
		return (EAttribute) eachContextEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getEachContext_IsFirst() {
		return (EAttribute) eachContextEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		eachContextEClass = createEClass(EACH_CONTEXT);
		createEAttribute(eachContextEClass, EACH_CONTEXT__IS_LAST);
		createEAttribute(eachContextEClass, EACH_CONTEXT__INDEX);
		createEAttribute(eachContextEClass, EACH_CONTEXT__IS_FIRST);
	...
	public void initializePackageContents() {
		...
		eachContextEClass.getESuperTypes().add(theStructurePackage.getObject());
		...
		EOperation op = addEOperation(collectionEClass, this.getJavaInteger(),
				"count", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(voidEClass, this.getJavaBoolean(), "isInstanceOf",
				0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(valueTypeEClass, null, "checkInvariants", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		...
		initEClass(eachContextEClass, EachContext.class, "EachContext",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEachContext_IsLast(), this.getJavaBoolean(),
				"isLast", "false", 0, 1, EachContext.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getEachContext_Index(), this.getJavaInteger(), "index",
				null, 0, 1, EachContext.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getEachContext_IsFirst(), this.getJavaBoolean(),
				"isFirst", "false", 0, 1, EachContext.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		op = addEOperation(eachContextEClass, this.getEachContext(),
				"initialize", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getJavaInteger(), "i", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, this.getJavaBoolean(), "first", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, this.getJavaBoolean(), "last", 0, 1, IS_UNIQUE,
				IS_ORDERED);
	...
	protected void createKermetaAnnotations() {
		...
		addAnnotation(iteratorEClass, source, new String[] { "CompilerIgnore",
				"true" });
		addAnnotation(
		...
		addAnnotation(unknownJavaObjectEClass, source, new String[] {
				"CompilerIgnore", "true" });
		...
		addAnnotation(voidEClass, source, new String[] { "CompilerIgnore",
				"true" });
		...
		addAnnotation(valueTypeEClass, source, new String[] { "CompilerIgnore",
				"true" });
		addAnnotation(valueTypeEClass, source, new String[] {
				"EMF_needProperty", "name=value javaClass=java.lang.String" });
		addAnnotation(
				valueTypeEClass.getEOperations().get(0),
				source,
				new String[] {
						"documentation",
						"/** \n     * checking invariants on ValueType is meaningless, so simply override the operation and do nothing\n     */" });
		addAnnotation(valueTypeEClass.getEOperations().get(0), source,
				new String[] { "superOperation",
						"kermeta::language::structure::Object" });
		addAnnotation(
				comparableEClass,
		...
		addAnnotation(comparableEClass, source, new String[] {
				"CompilerIgnore", "true" });
		...
		addAnnotation(summableEClass, source, new String[] { "CompilerIgnore",
				"true" });
		...
		addAnnotation(eachContextEClass, source, new String[] {
				"documentation",
		...
		addAnnotation(setEClass, source, new String[] { "CompilerIgnore",
				"true" });
		addAnnotation(
		...
		addAnnotation(bagEClass, source, new String[] { "CompilerIgnore",
				"true" });
		addAnnotation(
		...
		addAnnotation(orderedCollectionEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(
		...
		addAnnotation(orderedSetEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(
		...
		addAnnotation(orderedSetEClass.getEOperations().get(1), source,
				new String[] { "superOperation",
		...
		addAnnotation(orderedSetEClass.getEOperations().get(4), source,
				new String[] { "superOperation",
						"kermeta::standard::OrderedCollection" });
		addAnnotation(
		...
		addAnnotation(sequenceEClass, source, new String[] { "CompilerIgnore",
				"true" });
		addAnnotation(
