 ...
 * <ul>
 *   <li>{@link kermeta.standard.impl.ValueTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ValueTypeImpl extends ObjectImpl implements ValueType {
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					StandardPackage.VALUE_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case StandardPackage.VALUE_TYPE__VALUE:
			return getValue();
		}
