...
public class InterpreterPackageImpl extends EPackageImpl implements
	...
	protected void createKermetaAnnotations() {
		...
		addAnnotation(kermetaErrorEClass, source, new String[] {
				"CompilerIgnore", "true" });
		...
		addAnnotation(parseErrorEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(typeErrorEClass, source, new String[] { "documentation",
				"/**\n * Type errors in a code written in Kermeta\n */" });
		addAnnotation(typeErrorEClass, source, new String[] { "CompilerIgnore",
				"true" });
	}
