...
public class LanguageSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case LanguagePackage.REFLECTIVE_COLLECTION: {
			...
			if (result == null)
				result = caseSet(reflectiveCollection);
			if (result == null)
				result = caseCollection(reflectiveCollection);
			if (result == null)
				result = caseObject(reflectiveCollection);
			if (result == null)
		...
		case LanguagePackage.REFLECTIVE_SEQUENCE: {
			...
			if (result == null)
				result = caseOrderedSet(reflectiveSequence);
			if (result == null)
				result = caseReflectiveCollection(reflectiveSequence);
			if (result == null)
				result = caseSet(reflectiveSequence);
			if (result == null)
				result = caseOrderedCollection(reflectiveSequence);
			if (result == null)
				result = caseCollection(reflectiveSequence);
			if (result == null)
				result = caseObject(reflectiveSequence);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
