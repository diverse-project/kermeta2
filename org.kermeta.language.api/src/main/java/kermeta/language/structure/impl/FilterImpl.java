 ...
 * <ul>
 *   <li>{@link kermeta.language.structure.impl.FilterImpl#getQualifiedName <em>Qualified Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FilterImpl extends ObjectImpl implements Filter {
	...
	public void setQualifiedName(String newQualifiedName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					StructurePackage.FILTER__QUALIFIED_NAME, oldQualifiedName,
					qualifiedName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case StructurePackage.FILTER__QUALIFIED_NAME:
