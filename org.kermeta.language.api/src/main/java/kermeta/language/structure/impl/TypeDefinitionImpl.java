 ...
 * <ul>
 *   <li>{@link kermeta.language.structure.impl.TypeDefinitionImpl#getIsAspect <em>Is Aspect</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TypeDefinitionImpl extends NamedElementImpl implements
		TypeDefinition {
	/**
	...
	public void setIsAspect(Boolean newIsAspect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					StructurePackage.TYPE_DEFINITION__IS_ASPECT, oldIsAspect,
					isAspect));
	}
