...
public interface BehaviorPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int CALL_FEATURE__TARGET = CALL_EXPRESSION_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int CALL_FEATURE__STATIC_PROPERTY = CALL_EXPRESSION_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int ASSIGNMENT__VALUE = EXPRESSION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ASSIGNMENT__TARGET = EXPRESSION_FEATURE_COUNT + 1;
