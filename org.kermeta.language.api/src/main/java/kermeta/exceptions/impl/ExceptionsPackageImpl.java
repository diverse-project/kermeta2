...
public class ExceptionsPackageImpl extends EPackageImpl implements
	 ...
	 * @generated
	 */
	private EClass constraintsDiagnosticEClass = null;
	 ...
	 * @generated
	 */
	public EClass getConstraintsDiagnostic() {
		return constraintsDiagnosticEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getConstraintsDiagnostic_SetConstraints() {
		return (EReference) constraintsDiagnosticEClass
				.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		constraintsDiagnosticEClass = createEClass(CONSTRAINTS_DIAGNOSTIC);
		createEReference(constraintsDiagnosticEClass,
				CONSTRAINTS_DIAGNOSTIC__SET_CONSTRAINTS);
	...
	public void initializePackageContents() {
		...
		dynamicExpressionExceptionEClass.getESuperTypes().add(
				this.getException());
		constraintsDiagnosticEClass.getESuperTypes().add(
		...
		initEClass(constraintsDiagnosticEClass, ConstraintsDiagnostic.class,
				"ConstraintsDiagnostic", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		EGenericType g1 = createEGenericType(theStandardPackage.getBag());
		EGenericType g2 = createEGenericType(this.getConstraintViolatedInv());
		g1.getETypeArguments().add(g2);
		initEReference(getConstraintsDiagnostic_SetConstraints(), g1, null,
				"setConstraints", null, 0, 1, ConstraintsDiagnostic.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		addEOperation(constraintsDiagnosticEClass, null, "prettyPrint", 0, 1,
				IS_UNIQUE, IS_ORDERED);

		EOperation op = addEOperation(constraintsDiagnosticEClass, null, "add",
				0, 1, IS_UNIQUE, !IS_ORDERED);
		addEParameter(op, this.getConstraintViolatedInv(), "cons", 0, 1,
				IS_UNIQUE, IS_ORDERED);

		addEOperation(constraintsDiagnosticEClass, this
				.getConstraintsDiagnostic(), "initialize", 0, 1, IS_UNIQUE,
				IS_ORDERED);
	...
	protected void createKermetaAnnotations() {
		...
		addAnnotation(exceptionEClass, source, new String[] { "CompilerIgnore",
				"true" });
		...
		addAnnotation(runtimeErrorEClass, source, new String[] {
				"CompilerIgnore", "true" });
		...
		addAnnotation(typeCastErrorEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(
		...
		addAnnotation(notImplementedExceptionEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(
		...
		addAnnotation(upperBoundReachedErrorEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(
		...
		addAnnotation(abstractClassInstantiationErrorEClass, source,
				new String[] { "CompilerIgnore", "true" });
		addAnnotation(
		...
		addAnnotation(incompatibleTypeErrorEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(
		...
		addAnnotation(divisionByZeroEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(
				overflowErrorEClass,
				source,
		...
		addAnnotation(overflowErrorEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(voidOperandErrorEClass, source,
				new String[] { "documentation",
						"/** one of the required operands is void */" });
		addAnnotation(voidOperandErrorEClass, source, new String[] {
				"CompilerIgnore", "true" });
		...
		addAnnotation(
				...
				new String[] { "documentation",
						"/**\n * to be written #########################################\n */" });
		addAnnotation(stringFormatExceptionEClass, source, new String[] {
				"CompilerIgnore", "true" });
		...
		addAnnotation(emptyCollectionEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(
				iteratorIsOffEClass,
				source,
		...
		addAnnotation(iteratorIsOffEClass, source, new String[] {
				"CompilerIgnore", "true" });
		...
		addAnnotation(constraintViolatedExceptionEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(
		...
		addAnnotation(resourceMixedLevelsExceptionEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(
		...
		addAnnotation(resourceCreateExceptionEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(
		...
		addAnnotation(resourceUnconformityExceptionEClass, source,
				new String[] { "CompilerIgnore", "true" });
		addAnnotation(
		...
		addAnnotation(unregisteredMetamodelExceptionEClass, source,
				new String[] { "CompilerIgnore", "true" });
		addAnnotation(
				...
				new String[] { "documentation",
						"/**\n * to be written #########################################\n */" });
		addAnnotation(dynamicExpressionExceptionEClass, source, new String[] {
				"CompilerIgnore", "true" });
		addAnnotation(constraintsDiagnosticEClass, source, new String[] {
				"CompilerIgnore", "true" });
	}
