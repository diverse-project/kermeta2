...
// models.
//
public class KptMinimalModelHelper {
	
	private final static org.kermeta.kp.editor.util.KptEClassUtil eClassUtil = new org.kermeta.kp.editor.util.KptEClassUtil();
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + org.kermeta.kp.editor.util.KptStringUtil.capitalize(typeClass.getName());
