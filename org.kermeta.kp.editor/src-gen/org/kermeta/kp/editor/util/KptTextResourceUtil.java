...
public class KptTextResourceUtil {
	
	public static org.kermeta.kp.editor.mopp.KptResource getResource(org.eclipse.core.resources.IFile file) {
		...
		return (org.kermeta.kp.editor.mopp.KptResource) csResource;
	}
	
	public static org.kermeta.kp.editor.mopp.KptResource getResource(java.io.File file) {
		return getResource(file, null);
	}
	
	public static org.kermeta.kp.editor.mopp.KptResource getResource(java.io.File file, java.util.Map<?,?> options) {
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
