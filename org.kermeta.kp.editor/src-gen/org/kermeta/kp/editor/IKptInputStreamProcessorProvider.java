...
// encoding conversion.
//
public interface IKptInputStreamProcessorProvider {
	
	// Return a processor for the given input stream.
	//
	// @param inputStream the actual stream that provides the content of a resource
	// @return a processor that pre-processes the input stream
	public org.kermeta.kp.editor.mopp.KptInputStreamProcessor getInputStreamProcessor(java.io.InputStream inputStream);
}
