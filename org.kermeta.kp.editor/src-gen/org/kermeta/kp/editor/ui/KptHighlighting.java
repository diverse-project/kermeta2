...
public class KptHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private org.kermeta.kp.editor.ui.KptOccurrence occurrence;
	private org.kermeta.kp.editor.ui.KptBracketSet bracketSet;
	...
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.kermeta.kp.editor.IKptBackgroundParsingListener {
	...
	public KptHighlighting(org.kermeta.kp.editor.IKptTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.kermeta.kp.editor.ui.KptColorManager colorManager, org.kermeta.kp.editor.ui.KptEditor editor) {
		...
		bracketSet = new org.kermeta.kp.editor.ui.KptBracketSet(sourceviewer, "kpt");
	...
	private void addListeners(org.kermeta.kp.editor.ui.KptEditor editor) {
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, category);
		boolean isOccurrence = (category.equals(org.kermeta.kp.editor.ui.KptPositionCategory.DEFINTION.toString()) || category.equals(org.kermeta.kp.editor.ui.KptPositionCategory.PROXY.toString())) && lastStyleRange != null;
		if (category.equals(org.kermeta.kp.editor.ui.KptPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.kermeta.kp.editor.ui.KptEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
	...
	private void handleContentOutlineSelection(org.eclipse.jface.viewers.ISelection selection) {
		if (!selection.isEmpty()) {
			...
			if (selectedElement instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (resource instanceof org.kermeta.kp.editor.IKptTextResource) {
