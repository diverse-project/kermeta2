...
///
public class KptSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.kermeta.kp.editor.ui.KptSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kp.editor.ui.KptSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.kermeta.kp.editor.ui.KptSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kp.editor.ui.KptSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.kermeta.kp.editor.ui.KptSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kp.editor.ui.KptSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.kermeta.kp.editor.ui.KptSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kp.editor.ui.KptSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.kermeta.kp.editor.ui.KptSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kp.editor.ui.KptSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.kermeta.kp.editor.ui.KptSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.kermeta.kp.editor.ui.KptSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.kermeta.kp.editor.ui.KptPixelConverter pixelConverter = new org.kermeta.kp.editor.ui.KptPixelConverter(composite);
	...
	public KptSyntaxColoringPreferencePage() {
		super();
		
		org.kermeta.kp.editor.IKptMetaInformation syntaxPlugin = new org.kermeta.kp.editor.mopp.KptMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.kermeta.kp.editor.ui.KptEditor) {
			org.kermeta.kp.editor.ui.KptEditor emfTextEditor = (org.kermeta.kp.editor.ui.KptEditor) editor;
