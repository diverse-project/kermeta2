...
public class KptCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.kermeta.kp.editor.IKptBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.kermeta.kp.editor.ui.KptEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.kermeta.kp.editor.ui.KptEditor) {
				org.kermeta.kp.editor.ui.KptEditor editor = (org.kermeta.kp.editor.ui.KptEditor) workbenchPart;
	...
	protected org.kermeta.kp.editor.ui.KptEditor editor;
	...
	public KptCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.kermeta.kp.editor.ui.KptEditor textEditor) {
	...
	private void addCloseListener(final org.kermeta.kp.editor.ui.KptEditor editor) {
	...
	private java.io.File getCodeFoldingStateFile(String uriString) {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.kermeta.kp.editor.mopp.KptPlugin.PLUGIN_ID);
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.kermeta.kp.editor.mopp.KptPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.kermeta.kp.editor.IKptTextResource textResource = (org.kermeta.kp.editor.IKptTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
