...
public class KptBracketSet {
	...
	private class ClosingListener implements org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.kermeta.kp.editor.IKptBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	...
	public KptBracketSet(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String extension) {
		languageID = extension;
		this.bracketPairs = new java.util.ArrayList<org.kermeta.kp.editor.IKptBracketPair>();
		if (sourceViewer != null) {
			viewer = sourceViewer;
			textWidget = viewer.getTextWidget();
		}
		preferenceStore = org.kermeta.kp.editor.mopp.KptPlugin.getDefault().getPreferenceStore();
	...
	public org.kermeta.kp.editor.IKptBracketPair getBracketPair(String opening, String closing) {
		for (org.kermeta.kp.editor.IKptBracketPair bracketPair : bracketPairs) {
	...
	public boolean setClosingEnabledInside(org.kermeta.kp.editor.IKptBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.kermeta.kp.editor.ui.KptPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	public org.kermeta.kp.editor.IKptBracketPair remove(String opening, String closing) {
		for (org.kermeta.kp.editor.IKptBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.kermeta.kp.editor.IKptBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.kermeta.kp.editor.ui.KptPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.kermeta.kp.editor.ui.KptPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
