...
//
// A text editor for 'kpt' models.
//
public class KptEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	
	private org.kermeta.kp.editor.ui.KptHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.kermeta.kp.editor.ui.KptCodeFoldingManager codeFoldingManager;
	private org.kermeta.kp.editor.ui.KptBackgroundParsingStrategy bgParsingStrategy = new org.kermeta.kp.editor.ui.KptBackgroundParsingStrategy();
	private java.util.Collection<org.kermeta.kp.editor.IKptBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.kermeta.kp.editor.IKptBackgroundParsingListener>();
	private org.kermeta.kp.editor.ui.KptColorManager colorManager = new org.kermeta.kp.editor.ui.KptColorManager();
	private org.kermeta.kp.editor.ui.KptOutlinePage outlinePage;
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), KptEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.kermeta.kp.editor.IKptTextResource currentResource = getResource();
				...
				org.kermeta.kp.editor.mopp.KptPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.kermeta.kp.editor.ui.KptHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.kermeta.kp.editor.ui.KptCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.kermeta.kp.editor.mopp.KptNature.activate(inputFile.getProject());
		...
		org.kermeta.kp.editor.IKptTextResource loadedResource = (org.kermeta.kp.editor.IKptTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.kermeta.kp.editor.IKptTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.kermeta.kp.editor.IKptTextResource) {
					setResource((org.kermeta.kp.editor.IKptTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but
					// some other EMF resource
					org.kermeta.kp.editor.mopp.KptPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the KptEditor.");
					//close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				org.kermeta.kp.editor.mopp.KptPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.kermeta.kp.editor.IKptTextResource resource) {
		assert resource != null;
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.kermeta.kp.editor.IKptTextResource textResource = (org.kermeta.kp.editor.IKptTextResource) element.eResource();
			...
			org.kermeta.kp.editor.IKptTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.kermeta.kp.editor.IKptTextToken token = lexer.getNextToken();
			...
			org.kermeta.kp.editor.mopp.KptPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(org.kermeta.kp.editor.IKptBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.kermeta.kp.editor.IKptBackgroundParsingListener listener : bgParsingListeners) {
			...
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						...
						org.kermeta.kp.editor.mopp.KptPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}
