...
// @since 3.2
///
public class KptBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.kermeta.kp.editor.ui.KptDocBrowserInformationControlInput fInput;
	...
	public KptBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	...
	public KptBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	...
	// @since 3.4
	///
	public KptBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.kermeta.kp.editor.ui.KptDocBrowserInformationControlInput);
		...
		fInput= (org.kermeta.kp.editor.ui.KptDocBrowserInformationControlInput) input;
		...
		org.kermeta.kp.editor.ui.KptHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.kermeta.kp.editor.ui.KptHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	...
	///
	public org.kermeta.kp.editor.ui.KptDocBrowserInformationControlInput getInput() {
		return fInput;
	}
