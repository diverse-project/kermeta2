...
public class KptHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	...
	public KptHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof org.kermeta.kp.editor.ui.KptEditor) {
					org.kermeta.kp.editor.ui.KptEditor emftEditor = (org.kermeta.kp.editor.ui.KptEditor) editorPart;
