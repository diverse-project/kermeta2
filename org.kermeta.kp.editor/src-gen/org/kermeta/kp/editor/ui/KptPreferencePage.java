...
//
public class KptPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.kermeta.kp.editor.mopp.KptPlugin.getDefault().getPreferenceStore());
		setDescription(" Kpt Text Editor Preferences");
	}
