...
public class KptBackgroundParsingStrategy {
	...
	// a delay.
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.kermeta.kp.editor.IKptTextResource resource, final org.kermeta.kp.editor.ui.KptEditor editor) {
		if (resource == null) {
			return;
		}
