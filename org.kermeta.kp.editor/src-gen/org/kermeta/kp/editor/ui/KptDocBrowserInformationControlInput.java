...
public class KptDocBrowserInformationControlInput {
	
	private final KptDocBrowserInformationControlInput fPrevious;
	private KptDocBrowserInformationControlInput fNext;
	...
	///
	public KptDocBrowserInformationControlInput(KptDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	...
	public KptDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	...
	public KptDocBrowserInformationControlInput getNext() {
		return fNext;
	}
