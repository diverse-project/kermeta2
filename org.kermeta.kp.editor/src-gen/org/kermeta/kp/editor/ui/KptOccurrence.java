...
public class KptOccurrence {
	...
	//
	public KptOccurrence(org.kermeta.kp.editor.IKptTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, org.kermeta.kp.editor.ui.KptTokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new org.kermeta.kp.editor.mopp.KptMetaInformation().getTokenNames();
	...
	public void handleOccurrenceHighlighting(org.kermeta.kp.editor.ui.KptBracketSet bracketSet) {
