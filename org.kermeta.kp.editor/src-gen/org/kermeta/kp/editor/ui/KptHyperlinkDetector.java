...
// hovers, is a proxy.
public class KptHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	...
	public KptHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (org.kermeta.kp.editor.IKptTextResource) resource;
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlink[] detectHyperlinks(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion region, boolean canShowMultipleHyperlinks) {
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new org.kermeta.kp.editor.ui.KptHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
