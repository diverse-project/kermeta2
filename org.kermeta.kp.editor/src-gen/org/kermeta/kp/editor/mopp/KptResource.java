...
public class KptResource extends org.eclipse.emf.ecore.resource.impl.ResourceImpl implements org.kermeta.kp.editor.IKptTextResource {
	...
	private java.util.Map<java.lang.String, org.kermeta.kp.editor.IKptContextDependentURIFragment<? extends org.eclipse.emf.ecore.EObject>> internalURIFragmentMap = new java.util.HashMap<java.lang.String, org.kermeta.kp.editor.IKptContextDependentURIFragment<? extends org.eclipse.emf.ecore.EObject>>();
	...
	protected void doSave(java.io.OutputStream outputStream, java.util.Map<?,?> options) throws java.io.IOException {
		org.kermeta.kp.editor.mopp.KptPrinter printer = new org.kermeta.kp.editor.mopp.KptPrinter(outputStream, this);
		org.kermeta.kp.editor.IKptReferenceResolverSwitch referenceResolverSwitch = getReferenceResolverSwitch();
		referenceResolverSwitch.setOptions(options);
	...
	private org.eclipse.emf.ecore.EObject getResultElement(org.kermeta.kp.editor.IKptContextDependentURIFragment<? extends org.eclipse.emf.ecore.EObject> uriFragment, org.kermeta.kp.editor.IKptReferenceMapping<? extends org.eclipse.emf.ecore.EObject> mapping, org.eclipse.emf.ecore.EObject proxy, final java.lang.String errorMessage) {
		if (mapping instanceof org.kermeta.kp.editor.IKptURIMapping<?>) {
			...
			if (!uriFragment.getReference().isContainment() && oppositeReference != null) {
				if (reference.isMany()) {
					org.eclipse.emf.ecore.util.EObjectWithInverseResolvingEList.ManyInverse<org.eclipse.emf.ecore.EObject> list = org.kermeta.kp.editor.util.KptCastUtil.cast(element.eGet(oppositeReference, false));										//avoids duplicate entries in the reference caused by adding to the oppositeReference 
