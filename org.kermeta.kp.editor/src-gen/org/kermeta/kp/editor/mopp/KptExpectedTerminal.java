...
public class KptExpectedTerminal {
	
	private int followSetID;
	private org.kermeta.kp.editor.IKptExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	
	public KptExpectedTerminal(org.kermeta.kp.editor.IKptExpectedElement terminal, int followSetID) {
		super();
	...
	public org.kermeta.kp.editor.IKptExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		return this.terminal.equals(((KptExpectedTerminal) o).terminal);
	}
