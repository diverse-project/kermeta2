...
trait PropertyAdaptationOperatorAspect extends `kermeta_km2diag`.org.kermeta.language.structure.AdaptationOperatorAspect with `_root_`.org.kermeta.language.structure.PropertyAdaptationOperator{
