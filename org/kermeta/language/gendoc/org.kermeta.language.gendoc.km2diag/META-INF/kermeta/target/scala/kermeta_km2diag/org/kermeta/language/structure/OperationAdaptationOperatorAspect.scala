...
trait OperationAdaptationOperatorAspect extends `kermeta_km2diag`.org.kermeta.language.structure.AdaptationOperatorAspect with `_root_`.org.kermeta.language.structure.OperationAdaptationOperator{
  def Scalabody : _root_.java.lang.String={this.getBody().asInstanceOf[_root_.java.lang.String]}
  def Scalabody_=(`~value` : _root_.java.lang.String):Unit={
	this.setBody(`~value`)  }
