...
trait AssignmentAspect extends `kermeta_km2diag`.org.kermeta.language.behavior.ExpressionAspect with `_root_`.org.kermeta.language.behavior.Assignment{
  ...
  def Scalatarget_=(`~value` : _root_.org.kermeta.language.behavior.CallExpression):Unit={
  ...
  def Scalavalue_=(`~value` : _root_.org.kermeta.language.behavior.Expression):Unit={
	this.setValue(`~value`)  }
  def ScalaisCast : _root_.java.lang.Boolean={this.getIsCast().asInstanceOf[_root_.java.lang.Boolean]}
  def ScalaisCast_=(`~value` : _root_.java.lang.Boolean):Unit={
	this.setIsCast(`~value`)  }
