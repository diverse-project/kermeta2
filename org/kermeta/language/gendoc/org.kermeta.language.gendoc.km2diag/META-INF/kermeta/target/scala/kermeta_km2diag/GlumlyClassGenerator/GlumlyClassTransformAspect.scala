...
trait GlumlyClassTransformAspect  extends _root_.kermeta_km2diag.transform.Abstract_TransformationAspect with `_root_`.`kermeta_km2diag`.GlumlyClassGenerator.GlumlyClassTransform{
...
{
var visitor : _root_.`kermeta_km2diag`.GlumlyClassGenerator.GlumlyClassVisitor = _root_.kermeta_km2diag.GlumlyClassGenerator.KerRichFactory.createGlumlyClassVisitor;
...
`~result` = ("").asInstanceOf[Any];}
 ...
 return `~result`
  ...
  override def getMetaClass():_root_.org.kermeta.language.structure.Class={
    var cd : org.kermeta.language.structure.ClassDefinition =   _root_.k2.utils.ReflexivityLoader.getMetaClass("GlumlyClassGenerator.GlumlyClassTransform"); 
    if (cd !=null){ 
