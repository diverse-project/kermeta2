...
trait UnresolvedCallAspect extends `kermeta_km2diag`.org.kermeta.language.structure.UnresolvedReferenceAspect with `kermeta_km2diag`.org.kermeta.language.behavior.CallExpressionAspect with `kermeta_km2diag`.org.kermeta.language.structure.TypeContainerAspect with `_root_`.org.kermeta.language.behavior.UnresolvedCall{
  def Scalausings : k2.standard.ReflectiveOrderedSet[`kermeta_km2diag`.org.kermeta.language.behavior.UnresolvedCallAspect,_root_.org.kermeta.language.structure.Using]={    new k2.standard.RichReflectiveOrderedSet[`kermeta_km2diag`.org.kermeta.language.behavior.UnresolvedCallAspect,_root_.org.kermeta.language.structure.Using](thisUpper = -1,value=this.getUsings())}
  ...
  def ScalatargetParent_=(`~value` : _root_.org.kermeta.language.structure.Type):Unit={
	this.setTargetParent(`~value`)  }
  def Scalagenerics : k2.standard.ReflectiveOrderedSet[`kermeta_km2diag`.org.kermeta.language.behavior.UnresolvedCallAspect,_root_.org.kermeta.language.structure.Type]={    new k2.standard.RichReflectiveOrderedSet[`kermeta_km2diag`.org.kermeta.language.behavior.UnresolvedCallAspect,_root_.org.kermeta.language.structure.Type](thisUpper = -1,value=this.getGenerics())}
  ...
  def ScalaisCalledWithParenthesis_=(`~value` : _root_.java.lang.Boolean):Unit={
	this.setIsCalledWithParenthesis(`~value`)  }
