...
trait ClassDefinitionAspect extends `kermeta_km2diag`.org.kermeta.language.structure.GenericTypeDefinitionAspect with `kermeta_km2diag`.transform.`Abstract_VisitableElementAspect` with `_root_`.org.kermeta.language.structure.ClassDefinition{
  ...
  def Scalainv_=(`~value` : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.Constraint]):Unit={
	this.getInv().clear
  ...
  def ScalaownedAttribute_=(`~value` : k2.standard.KermetaSet[_root_.org.kermeta.language.structure.Property]):Unit={
  ...
  def ScalaownedOperation_=(`~value` : k2.standard.KermetaSet[_root_.org.kermeta.language.structure.Operation]):Unit={
