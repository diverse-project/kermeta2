...
trait CallPropertyAspect extends `kermeta_km2diag`.org.kermeta.language.behavior.CallFeatureAspect with `_root_`.org.kermeta.language.behavior.CallProperty{
  ...
  def ScalastaticProperty_=(`~value` : _root_.org.kermeta.language.structure.Property):Unit={
	this.setStaticProperty(`~value`)  }
