...
trait ConstraintAspect extends `kermeta_km2diag`.org.kermeta.language.structure.NamedElementAspect with `_root_`.org.kermeta.language.structure.Constraint{
  ...
  def Scalastereotype_=(`~value` : _root_.org.kermeta.language.structure.ConstraintType):Unit={
  ...
  def Scalalanguage_=(`~value` : _root_.org.kermeta.language.structure.ConstraintLanguage):Unit={
  ...
  def ScalainvOwner_=(`~value` : _root_.org.kermeta.language.structure.ClassDefinition):Unit={
	this.setInvOwner(`~value`)  }
  ...
  def ScalapreOwner_=(`~value` : _root_.org.kermeta.language.structure.Operation):Unit={
	this.setPreOwner(`~value`)  }
  ...
  def ScalapostOwner_=(`~value` : _root_.org.kermeta.language.structure.Operation):Unit={
	this.setPostOwner(`~value`)  }
