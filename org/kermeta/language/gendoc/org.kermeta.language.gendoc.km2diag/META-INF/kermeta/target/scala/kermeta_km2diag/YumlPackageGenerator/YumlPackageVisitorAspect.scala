...
trait YumlPackageVisitorAspect  extends _root_.kermeta_km2diag.transform.Abstract_PackageVisitorAspect with `_root_`.`kermeta_km2diag`.YumlPackageGenerator.YumlPackageVisitor{
...

{
  ...
  override def getMetaClass():_root_.org.kermeta.language.structure.Class={
    var cd : org.kermeta.language.structure.ClassDefinition =   _root_.k2.utils.ReflexivityLoader.getMetaClass("YumlPackageGenerator.YumlPackageVisitor"); 
    if (cd !=null){ 
