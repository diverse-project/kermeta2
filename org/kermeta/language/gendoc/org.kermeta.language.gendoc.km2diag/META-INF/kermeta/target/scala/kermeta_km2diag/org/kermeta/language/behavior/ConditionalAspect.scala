...
trait ConditionalAspect extends `kermeta_km2diag`.org.kermeta.language.behavior.ExpressionAspect with `_root_`.org.kermeta.language.behavior.Conditional{
  ...
  def ScalathenBody_=(`~value` : _root_.org.kermeta.language.behavior.Expression):Unit={
	this.setThenBody(`~value`)  }
  ...
  def ScalaelseBody_=(`~value` : _root_.org.kermeta.language.behavior.Expression):Unit={
	this.setElseBody(`~value`)  }
  ...
  def Scalacondition_=(`~value` : _root_.org.kermeta.language.behavior.Expression):Unit={
