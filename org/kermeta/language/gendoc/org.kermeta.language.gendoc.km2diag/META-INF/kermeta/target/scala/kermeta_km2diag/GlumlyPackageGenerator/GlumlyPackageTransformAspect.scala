...
trait GlumlyPackageTransformAspect  extends _root_.kermeta_km2diag.transform.Abstract_TransformationAspect with `_root_`.`kermeta_km2diag`.GlumlyPackageGenerator.GlumlyPackageTransform{
...
{
var visitor : _root_.`kermeta_km2diag`.GlumlyPackageGenerator.GlumlyPackageVisitor = _root_.kermeta_km2diag.GlumlyPackageGenerator.KerRichFactory.createGlumlyPackageVisitor;
...
`~result` = ("").asInstanceOf[Any];}
 ...
 return `~result`
  ...
  override def getMetaClass():_root_.org.kermeta.language.structure.Class={
    var cd : org.kermeta.language.structure.ClassDefinition =   _root_.k2.utils.ReflexivityLoader.getMetaClass("GlumlyPackageGenerator.GlumlyPackageTransform"); 
    if (cd !=null){ 
