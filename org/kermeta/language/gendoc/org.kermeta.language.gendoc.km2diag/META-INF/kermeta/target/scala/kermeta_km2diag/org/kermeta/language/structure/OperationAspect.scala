...
trait OperationAspect extends `kermeta_km2diag`.org.kermeta.language.structure.MultiplicityElementAspect with `kermeta_km2diag`.org.kermeta.language.structure.AbstractOperationAspect with `_root_`.org.kermeta.language.structure.Operation{
  def ScalaraisedException : k2.standard.ReflectiveOrderedSet[`kermeta_km2diag`.org.kermeta.language.structure.OperationAspect,_root_.org.kermeta.language.structure.Type]={    new k2.standard.RichReflectiveOrderedSet[`kermeta_km2diag`.org.kermeta.language.structure.OperationAspect,_root_.org.kermeta.language.structure.Type](thisUpper = -1,value=this.getRaisedException())}
  def ScalaraisedException_=(`~value` : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.Type]):Unit={
	this.getRaisedException().clear
  ...
  def Scalapre_=(`~value` : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.Constraint]):Unit={
	this.getPre().clear
  ...
  def Scalapost_=(`~value` : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.Constraint]):Unit={
	this.getPost().clear
  ...
  def Scalabody_=(`~value` : _root_.org.kermeta.language.behavior.Expression):Unit={
	this.setBody(`~value`)  }
  def ScalaownedUnresolvedOperations : k2.standard.ReflectiveOrderedSet[`kermeta_km2diag`.org.kermeta.language.structure.OperationAspect,_root_.org.kermeta.language.structure.UnresolvedOperation]={    new k2.standard.RichReflectiveOrderedSet[`kermeta_km2diag`.org.kermeta.language.structure.OperationAspect,_root_.org.kermeta.language.structure.UnresolvedOperation](thisUpper = -1,value=this.getOwnedUnresolvedOperations())}
  def ScalaownedUnresolvedOperations_=(`~value` : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.UnresolvedOperation]):Unit={
	this.getOwnedUnresolvedOperations().clear
  ...
  def ScalaowningClass_=(`~value` : _root_.org.kermeta.language.structure.ClassDefinition):Unit={
	this.setOwningClass(`~value`)  }
  def ScalatypeParameter : k2.standard.ReflectiveOrderedSet[`kermeta_km2diag`.org.kermeta.language.structure.OperationAspect,_root_.org.kermeta.language.structure.TypeVariable]={    new k2.standard.RichReflectiveOrderedSet[`kermeta_km2diag`.org.kermeta.language.structure.OperationAspect,_root_.org.kermeta.language.structure.TypeVariable](thisUpper = -1,value=this.getTypeParameter())}
  ...
  def ScalauniqueName_=(`~value` : _root_.java.lang.String):Unit={
