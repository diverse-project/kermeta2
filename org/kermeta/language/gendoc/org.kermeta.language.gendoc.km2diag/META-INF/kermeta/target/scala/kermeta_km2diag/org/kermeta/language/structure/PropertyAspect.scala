...
trait PropertyAspect extends `kermeta_km2diag`.org.kermeta.language.structure.MultiplicityElementAspect with `kermeta_km2diag`.org.kermeta.language.structure.AbstractPropertyAspect with `kermeta_km2diag`.transform.`Abstract_VisitableElementAspect` with `_root_`.org.kermeta.language.structure.Property{
  ...
  def Scalaopposite_=(`~value` : _root_.org.kermeta.language.structure.AbstractProperty):Unit={
  ...
  def ScalagetterBody_=(`~value` : _root_.org.kermeta.language.behavior.Expression):Unit={
	this.setGetterBody(`~value`)  }
  ...
  def ScalasetterBody_=(`~value` : _root_.org.kermeta.language.behavior.Expression):Unit={
	this.setSetterBody(`~value`)  }
  def ScalaisGetterAbstract : _root_.java.lang.Boolean={this.getIsGetterAbstract().asInstanceOf[_root_.java.lang.Boolean]}
  def ScalaisGetterAbstract_=(`~value` : _root_.java.lang.Boolean):Unit={
	this.setIsGetterAbstract(`~value`)  }
  def ScalaisSetterAbstract : _root_.java.lang.Boolean={this.getIsSetterAbstract().asInstanceOf[_root_.java.lang.Boolean]}
  def ScalaisSetterAbstract_=(`~value` : _root_.java.lang.Boolean):Unit={
	this.setIsSetterAbstract(`~value`)  }
  def ScalaownedUnresolvedProperties : k2.standard.ReflectiveOrderedSet[`kermeta_km2diag`.org.kermeta.language.structure.PropertyAspect,_root_.org.kermeta.language.structure.UnresolvedProperty]={    new k2.standard.RichReflectiveOrderedSet[`kermeta_km2diag`.org.kermeta.language.structure.PropertyAspect,_root_.org.kermeta.language.structure.UnresolvedProperty](thisUpper = -1,value=this.getOwnedUnresolvedProperties())}
  def ScalaownedUnresolvedProperties_=(`~value` : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.UnresolvedProperty]):Unit={
	this.getOwnedUnresolvedProperties().clear
