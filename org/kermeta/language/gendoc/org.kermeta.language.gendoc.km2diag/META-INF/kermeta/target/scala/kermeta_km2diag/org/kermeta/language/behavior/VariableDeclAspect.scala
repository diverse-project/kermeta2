...
trait VariableDeclAspect extends `kermeta_km2diag`.org.kermeta.language.behavior.ExpressionAspect with `_root_`.org.kermeta.language.behavior.VariableDecl{
  ...
  def Scalaidentifier_=(`~value` : _root_.java.lang.String):Unit={
