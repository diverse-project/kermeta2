...
trait LoopAspect extends `kermeta_km2diag`.org.kermeta.language.behavior.ExpressionAspect with `_root_`.org.kermeta.language.behavior.Loop{
  ...
  def Scalainitialization_=(`~value` : _root_.org.kermeta.language.behavior.Expression):Unit={
  ...
  def ScalastopCondition_=(`~value` : _root_.org.kermeta.language.behavior.Expression):Unit={
