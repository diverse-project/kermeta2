...
trait ModelTypeVariableAspect extends `kermeta_km2diag`.org.kermeta.language.structure.TypeVariableAspect with `_root_`.org.kermeta.language.structure.ModelTypeVariable{
  ...
  def ScalavirtualType_=(`~value` : k2.standard.KermetaOrderedSet[_root_.org.kermeta.language.structure.VirtualType]):Unit={
	this.getVirtualType().clear
