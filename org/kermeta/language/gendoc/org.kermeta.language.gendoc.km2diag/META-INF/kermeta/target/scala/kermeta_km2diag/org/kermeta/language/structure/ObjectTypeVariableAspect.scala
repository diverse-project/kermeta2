...
trait ObjectTypeVariableAspect extends `kermeta_km2diag`.org.kermeta.language.structure.TypeVariableAspect with `_root_`.org.kermeta.language.structure.ObjectTypeVariable{
