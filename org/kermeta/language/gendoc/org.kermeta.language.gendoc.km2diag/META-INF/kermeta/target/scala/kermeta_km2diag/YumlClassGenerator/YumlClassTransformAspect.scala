...
trait YumlClassTransformAspect  extends _root_.kermeta_km2diag.transform.Abstract_TransformationAspect with `_root_`.`kermeta_km2diag`.YumlClassGenerator.YumlClassTransform{
...
{
var visitor : _root_.`kermeta_km2diag`.YumlClassGenerator.YumlClassVisitor = _root_.kermeta_km2diag.YumlClassGenerator.KerRichFactory.createYumlClassVisitor;
...
`~result` = ("").asInstanceOf[Any];}
 ...
 return `~result`
  ...
  override def getMetaClass():_root_.org.kermeta.language.structure.Class={
    var cd : org.kermeta.language.structure.ClassDefinition =   _root_.k2.utils.ReflexivityLoader.getMetaClass("YumlClassGenerator.YumlClassTransform"); 
    if (cd !=null){ 
