...
trait TypeContainerAspect extends `kermeta_km2diag`.org.kermeta.language.structure.KermetaModelElementAspect with `_root_`.org.kermeta.language.structure.TypeContainer{
  ...
  def ScalacontainedType_=(`~value` : k2.standard.KermetaSet[_root_.org.kermeta.language.structure.Type]):Unit={
	this.getContainedType().clear
