...
trait ClearAspect extends `logo_compilerNXC`.kmLogo.ASM.PrimitiveAspect with `_root_`.kmLogo.ASM.Clear{
...
{
`~result` = ("// RESET NOT IMPLEMENTED").asInstanceOf[_root_.java.lang.String];}
        }
 return `~result`
}
  override def getMetaClass():_root_.org.kermeta.language.structure.Class={
    var cd : org.kermeta.language.structure.ClassDefinition =   _root_.k2.utils.ReflexivityLoader.getMetaClass("kmLogo.ASM.Clear"); 
    if (cd !=null){ 
