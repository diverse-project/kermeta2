...
trait ConstantAspect extends `logo_compilerNXC`.kmLogo.ASM.ExpressionAspect with `_root_`.kmLogo.ASM.Constant{
...
{
if (((this).ScalaintegerValue).isGreaterOrEqual(0))

{
`~result` = (_root_.k2.utils.UTilScala.toString(((this).ScalaintegerValue))).asInstanceOf[_root_.java.lang.String];}
else 


{
`~result` = ((("(").plus(_root_.k2.utils.UTilScala.toString(((this).ScalaintegerValue)))).plus(")")).asInstanceOf[_root_.java.lang.String];}
}
        }
 return `~result`
}
