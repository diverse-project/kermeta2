...
trait LeftAspect extends `logo_compilerNXC`.kmLogo.ASM.PrimitiveAspect with `_root_`.kmLogo.ASM.Left{
...
{
`~result` = ((("turn(").plus(((this).Scalaangle).compileToNXC(context))).plus(");")).asInstanceOf[_root_.java.lang.String];}
        }
 return `~result`
}
