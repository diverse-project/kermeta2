...
trait PenDownAspect extends `logo_compilerNXC`.kmLogo.ASM.PrimitiveAspect with `_root_`.kmLogo.ASM.PenDown{
...
{
`~result` = ("penDown();").asInstanceOf[_root_.java.lang.String];}
        }
 return `~result`
}
