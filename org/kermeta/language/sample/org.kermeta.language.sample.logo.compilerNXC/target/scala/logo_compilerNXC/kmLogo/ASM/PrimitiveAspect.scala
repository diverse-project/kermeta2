...
trait PrimitiveAspect extends `logo_compilerNXC`.kmLogo.ASM.InstructionAspect with `_root_`.kmLogo.ASM.Primitive{
...
`~result` = (null).asInstanceOf[_root_.java.lang.String];}
 ...
 return `~result`
  ...
  override def getMetaClass():_root_.org.kermeta.language.structure.Class={
    var cd : org.kermeta.language.structure.ClassDefinition =   _root_.k2.utils.ReflexivityLoader.getMetaClass("kmLogo.ASM.Primitive"); 
    if (cd !=null){ 
