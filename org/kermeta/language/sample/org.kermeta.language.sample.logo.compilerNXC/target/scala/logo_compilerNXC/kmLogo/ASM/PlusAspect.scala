...
trait PlusAspect extends `logo_compilerNXC`.kmLogo.ASM.BinaryExpAspect with `_root_`.kmLogo.ASM.Plus{
...
`~result` = (((((this).Scalalhs).compileToNXC(context)).plus(" + ")).plus(((this).Scalarhs).compileToNXC(context))).asInstanceOf[_root_.java.lang.String];}
 ...
 return `~result`
  ...
  override def getMetaClass():_root_.org.kermeta.language.structure.Class={
    var cd : org.kermeta.language.structure.ClassDefinition =   _root_.k2.utils.ReflexivityLoader.getMetaClass("kmLogo.ASM.Plus"); 
    if (cd !=null){ 
