...
trait InstructionAspect extends k2.standard.KermetaObjectAspect with `_root_`.kmLogo.ASM.Instruction{
...
{
`~result` = ("// NOT IMPLEMENTED").asInstanceOf[_root_.java.lang.String];}
        }
 return `~result`
}
  override def getMetaClass():_root_.org.kermeta.language.structure.Class={
    var cd : org.kermeta.language.structure.ClassDefinition =   _root_.k2.utils.ReflexivityLoader.getMetaClass("kmLogo.ASM.Instruction"); 
    if (cd !=null){ 
