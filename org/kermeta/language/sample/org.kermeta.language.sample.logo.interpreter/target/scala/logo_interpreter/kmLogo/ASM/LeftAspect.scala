...
trait LeftAspect extends `logo_interpreter`.kmLogo.ASM.PrimitiveAspect with `_root_`.kmLogo.ASM.Left{
...
{
((context).Scalaturtle).rotate((((this).Scalaangle).eval(context)).uminus())
