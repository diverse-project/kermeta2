...
trait ProcDeclarationAspect extends `logo_interpreter`.kmLogo.ASM.InstructionAspect with `_root_`.kmLogo.ASM.ProcDeclaration{
  ...
  def Scalaname_=(`~value` : _root_.java.lang.String):Unit={
	this.setName(`~value`)  }
  def Scalaargs : k2.standard.ReflectiveOrderedSet[`logo_interpreter`.kmLogo.ASM.ProcDeclarationAspect,_root_.kmLogo.ASM.Parameter]={    new k2.standard.RichReflectiveOrderedSet[`logo_interpreter`.kmLogo.ASM.ProcDeclarationAspect,_root_.kmLogo.ASM.Parameter](thisUpper = -1,value=this.getArgs())}
  ...
  def Scalainstructions : k2.standard.ReflectiveOrderedSet[`logo_interpreter`.kmLogo.ASM.ProcDeclarationAspect,_root_.kmLogo.ASM.Instruction]={    new k2.standard.RichReflectiveOrderedSet[`logo_interpreter`.kmLogo.ASM.ProcDeclarationAspect,_root_.kmLogo.ASM.Instruction](thisUpper = -1,value=this.getInstructions())}
