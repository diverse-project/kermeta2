...
trait EqualsAspect extends `logo_interpreter`.kmLogo.ASM.BinaryExpAspect with `_root_`.kmLogo.ASM.Equals{
...
{
if (((((this).Scalalhs).eval(context)) == (((this).Scalarhs).eval(context))))
...
`~result` = (1).asInstanceOf[_root_.java.lang.Integer];}
 ...
 return `~result`
  ...
  override def getMetaClass():_root_.org.kermeta.language.structure.Class={
    var cd : org.kermeta.language.structure.ClassDefinition =   _root_.k2.utils.ReflexivityLoader.getMetaClass("kmLogo.ASM.Equals"); 
    if (cd !=null){ 
