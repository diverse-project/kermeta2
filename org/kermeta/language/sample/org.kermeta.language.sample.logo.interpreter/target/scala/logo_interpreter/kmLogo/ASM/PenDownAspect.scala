...
trait PenDownAspect extends `logo_interpreter`.kmLogo.ASM.PrimitiveAspect with `_root_`.kmLogo.ASM.PenDown{
...
{
((context).Scalaturtle).ScalapenUp = (false).asInstanceOf[_root_.java.lang.Boolean];
`~result` = (null).asInstanceOf[_root_.java.lang.Integer];}
        }
 return `~result`
}
  override def getMetaClass():_root_.org.kermeta.language.structure.Class={
    var cd : org.kermeta.language.structure.ClassDefinition =   _root_.k2.utils.ReflexivityLoader.getMetaClass("kmLogo.ASM.PenDown"); 
    if (cd !=null){ 
