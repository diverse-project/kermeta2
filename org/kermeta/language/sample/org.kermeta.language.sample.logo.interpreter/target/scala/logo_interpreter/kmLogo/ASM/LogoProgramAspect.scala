...
trait LogoProgramAspect extends k2.standard.KermetaObjectAspect with `_root_`.kmLogo.ASM.LogoProgram{
  def Scalainstructions : k2.standard.ReflectiveOrderedSet[`logo_interpreter`.kmLogo.ASM.LogoProgramAspect,_root_.kmLogo.ASM.Instruction]={    new k2.standard.RichReflectiveOrderedSet[`logo_interpreter`.kmLogo.ASM.LogoProgramAspect,_root_.kmLogo.ASM.Instruction](thisUpper = -1,value=this.getInstructions())}
