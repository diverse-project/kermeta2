...
trait ForwardAspect extends `logo_interpreter`.kmLogo.ASM.PrimitiveAspect with `_root_`.kmLogo.ASM.Forward{
...
{
((context).Scalaturtle).forward(((this).Scalasteps).eval(context))
