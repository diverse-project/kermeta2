...
public class LogoTextualSyntaxStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.kermeta.language.sample.logo.LogoTextualSyntaxRuntimeModule());
	}
