 ...
 * <ul>
 *   <li>{@link org.kermeta.language.sample.logo.model.logoASM.impl.ConstantImpl#getIntegerValue <em>Integer Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConstantImpl extends ExpressionImpl implements Constant {
	...
	protected EClass eStaticClass() {
		return LogoASMPackage.Literals.CONSTANT;
	}
	...
	public void setIntegerValue(int newIntegerValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogoASMPackage.CONSTANT__INTEGER_VALUE, oldIntegerValue, integerValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LogoASMPackage.CONSTANT__INTEGER_VALUE:
