...
import org.kermeta.language.sample.logo.model.logoASM.Constant;
...
import org.kermeta.language.sample.logo.model.logoASM.Lower;
import org.kermeta.language.sample.logo.model.logoASM.Minus;
import org.kermeta.language.sample.logo.model.logoASM.Mult;
...
import org.kermeta.language.sample.logo.model.logoASM.PenUp;
import org.kermeta.language.sample.logo.model.logoASM.Plus;
...
import org.kermeta.language.sample.logo.model.logoASM.Right;
import org.kermeta.language.sample.logo.model.logoASM.While;
import org.kermeta.language.sample.logo.model.logoASM.logoASMFactory;
 ...
 * @generated
 */
public class logoASMPackageImpl extends EPackageImpl implements logoASMPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.kermeta.language.sample.logo.model.logoASM.logoASMPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private logoASMPackageImpl() {
		super(eNS_URI, logoASMFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link logoASMPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static logoASMPackage init() {
		if (isInited) return (logoASMPackage)EPackage.Registry.INSTANCE.getEPackage(logoASMPackage.eNS_URI);

		// Obtain or create and register package
		logoASMPackageImpl thelogoASMPackage = (logoASMPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof logoASMPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new logoASMPackageImpl());

		isInited = true;

		// Create package meta-data objects
		thelogoASMPackage.createPackageContents();

		// Initialize created meta-data
		thelogoASMPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		thelogoASMPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(logoASMPackage.eNS_URI, thelogoASMPackage);
		return thelogoASMPackage;
	}
	 ...
	 * @generated
	 */
	public logoASMFactory getlogoASMFactory() {
		return (logoASMFactory)getEFactoryInstance();
	}
