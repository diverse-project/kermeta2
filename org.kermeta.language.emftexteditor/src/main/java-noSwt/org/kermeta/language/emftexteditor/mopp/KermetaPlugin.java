...
public class KermetaPlugin /*extends org.eclipse.ui.plugin.AbstractUIPlugin*/ {
	
	public static final String PLUGIN_ID = "fr.irisa.triskell.kermeta.resource.kermeta";
	public static final String EMFTEXT_SDK_VERSION = "1.2.2";
