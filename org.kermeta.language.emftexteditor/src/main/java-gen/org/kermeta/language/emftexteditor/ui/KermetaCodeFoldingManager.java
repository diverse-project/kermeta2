...
public class KermetaCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.kermeta.language.emftexteditor.IKermetaBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.kermeta.language.emftexteditor.ui.KermetaEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.kermeta.language.emftexteditor.ui.KermetaEditor) {
				org.kermeta.language.emftexteditor.ui.KermetaEditor editor = (org.kermeta.language.emftexteditor.ui.KermetaEditor) workbenchPart;
	...
	protected org.kermeta.language.emftexteditor.ui.KermetaEditor editor;
	...
	public KermetaCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.kermeta.language.emftexteditor.ui.KermetaEditor textEditor) {
	...
	private void addCloseListener(final org.kermeta.language.emftexteditor.ui.KermetaEditor editor) {
	...
	// Deletes old org.eclipse.jface.text.source.projection.ProjectionAnnotation with line count < 2.
	//
	...
	// Checks the offset of this <code>org.eclipse.jface.text.Position</code> with the
	// <code>org.eclipse.jface.text.Position</code>s in <code>additions</code> to determine the
	// existence.
	//
	...
	//
	// @param uriString the key to determine the file name
	...
	//
	// @param uriString the key to determine the file name to save
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.kermeta.language.emftexteditor.mopp.KermetaPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.kermeta.language.emftexteditor.IKermetaTextResource textResource = (org.kermeta.language.emftexteditor.IKermetaTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
