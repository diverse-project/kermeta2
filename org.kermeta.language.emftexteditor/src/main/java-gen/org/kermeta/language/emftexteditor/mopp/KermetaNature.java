...
public class KermetaNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.kermeta.language.emftexteditor.nature";
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.kermeta.language.emftexteditor.mopp.KermetaBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
