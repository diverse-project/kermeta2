...
public class KermetaCopiedEList<E> implements org.eclipse.emf.common.util.EList<E> {
	...
	public KermetaCopiedEList(org.eclipse.emf.common.util.EList<E> original) {
		super();
