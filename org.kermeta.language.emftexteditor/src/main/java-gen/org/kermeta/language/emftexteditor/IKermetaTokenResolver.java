 ...
 * instance of KermetaDefaultTokenResolver which performs a standard conversion
 * based on the EMF type conversion. This includes conversion of registered
 * EDataTypes.
 * 
 * @see org.kermeta.language.emftexteditor.analysis.KermetaDefaultTokenResolver
 */
public interface IKermetaTokenResolver extends org.kermeta.language.emftexteditor.IKermetaConfigurable {
	 ...
	 * errors
	 */
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.kermeta.language.emftexteditor.IKermetaTokenResolveResult result);
