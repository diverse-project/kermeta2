...
public class KermetaBackgroundParsingStrategy {
	...
	// a delay.
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.kermeta.language.emftexteditor.IKermetaTextResource resource, final org.kermeta.language.emftexteditor.ui.KermetaEditor editor) {
		if (resource == null) {
			return;
		}
