...
// @since 3.2
///
public class KermetaBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	
	// Tells whether the org.eclipse.swt.SWT org.eclipse.swt.browser.Browser widget and hence this information
	...
	private org.kermeta.language.emftexteditor.ui.KermetaDocBrowserInformationControlInput fInput;
	...
	public KermetaBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	...
	public KermetaBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	...
	// @since 3.4
	///
	public KermetaBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	//
	// @see org.eclipse.jface.text.org.eclipse.jface.text.AbstractInformationControl#createContent(org.eclipse.swt.widgets.org.eclipse.swt.widgets.Composite)
	///
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.kermeta.language.emftexteditor.ui.KermetaDocBrowserInformationControlInput);
		...
		fInput= (org.kermeta.language.emftexteditor.ui.KermetaDocBrowserInformationControlInput) input;
		...
		if (RTL && resizable) {
			...
			styles= new String[] { "overflow:hidden;"/*, "word-wrap: break-word;"*/ }; 		} else {
			styles= new String[] { "overflow:scroll;" }; 		}
		
		StringBuffer buffer= new StringBuffer(content);
		org.kermeta.language.emftexteditor.ui.KermetaHTMLPrinter.insertStyles(buffer, styles);
	...
	public void setVisible(boolean visible) {
		...
		//
		// The org.eclipse.swt.browser.Browser widget flickers when made visible while it is not completely loaded.
	...
	//
	// @see org.eclipse.jface.text.org.eclipse.jface.text.AbstractInformationControl#setSize(int, int)
	///
	...
	private void createTextLayout() {
		...
		fTextLayout.setText("    "); 		int tabWidth = fTextLayout.getBounds().width;
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.kermeta.language.emftexteditor.ui.KermetaHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	...
	//
	// @see org.eclipse.jface.text.org.eclipse.jface.text.IDelayedInputChangeProvider#setDelayedInputChangeListener(org.eclipse.jface.text.org.eclipse.jface.text.IInputChangedListener)
	// @since 3.4
	///
	...
	///
	public org.kermeta.language.emftexteditor.ui.KermetaDocBrowserInformationControlInput getInput() {
		return fInput;
	}
