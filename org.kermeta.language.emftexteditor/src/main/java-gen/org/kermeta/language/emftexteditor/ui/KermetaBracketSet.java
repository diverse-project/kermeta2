...
public class KermetaBracketSet {
	...
	public KermetaBracketSet(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String extension) {
	...
	// Removes all bracket pairs from this bracket set, reload the bracket set from the preference store.
	...
	// the <code>org.eclipse.jface.preference.IPreferenceStore</code>.
	//
	...
	// information will be stored in the <code>org.eclipse.jface.text.IDocument</code> in the category
