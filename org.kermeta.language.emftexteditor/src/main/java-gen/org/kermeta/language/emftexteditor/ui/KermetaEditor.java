...
public class KermetaEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
				...
				org.kermeta.language.emftexteditor.mopp.KermetaPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
		...
		if (loadedResource == null) {
			try {
				...
				if (demandLoadedResource instanceof org.kermeta.language.emftexteditor.IKermetaTextResource) {
					...
					org.kermeta.language.emftexteditor.mopp.KermetaPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the KermetaEditor.");
					//close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				org.kermeta.language.emftexteditor.mopp.KermetaPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.kermeta.language.emftexteditor.mopp.KermetaPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
			...
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						...
						org.kermeta.language.emftexteditor.mopp.KermetaPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}
