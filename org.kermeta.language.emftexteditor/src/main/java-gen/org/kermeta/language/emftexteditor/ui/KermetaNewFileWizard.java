...
public class KermetaNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.kermeta.language.emftexteditor.ui.KermetaNewFileWizardPage page;
	...
	public void addPages() {
		page = new org.kermeta.language.emftexteditor.ui.KermetaNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.kermeta.language.emftexteditor.mopp.KermetaPlugin.logError("java.lang.Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.kermeta.language.emftexteditor.mopp.KermetaPlugin.logError("java.lang.Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.kermeta.language.emftexteditor.mopp.KermetaMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public java.lang.String getFileExtension() {
		return new org.kermeta.language.emftexteditor.mopp.KermetaMetaInformation().getSyntaxName();
	}
