 ...
 * conversion.
 */
public interface IKermetaInputStreamProcessorProvider {
	 ...
	 */
	public org.kermeta.language.emftexteditor.mopp.KermetaInputStreamProcessor getInputStreamProcessor(java.io.InputStream inputStream);
}
