...
public class KermetaHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static org.kermeta.language.emftexteditor.ui.KermetaPositionHelper positionHelper = new org.kermeta.language.emftexteditor.ui.KermetaPositionHelper();
	private boolean isHighlightBrackets = true;
	private boolean isHighlightOccurrences = true;
	private org.kermeta.language.emftexteditor.ui.KermetaTokenScanner scanner;
	...
	private org.kermeta.language.emftexteditor.ui.KermetaOccurrence occurrence;
	private org.kermeta.language.emftexteditor.ui.KermetaBracketSet bracketSet;
	...
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.kermeta.language.emftexteditor.IKermetaBackgroundParsingListener {
	...
	public KermetaHighlighting(org.kermeta.language.emftexteditor.IKermetaTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.kermeta.language.emftexteditor.ui.KermetaColorManager colorManager, org.kermeta.language.emftexteditor.ui.KermetaEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.kermeta.language.emftexteditor.mopp.KermetaPlugin.getDefault().getPreferenceStore();
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.kermeta.language.emftexteditor.ui.KermetaTokenScanner(colorManager);
		occurrence = new org.kermeta.language.emftexteditor.ui.KermetaOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.kermeta.language.emftexteditor.ui.KermetaBracketSet(sourceviewer, "kermeta");
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.kermeta.language.emftexteditor.ui.KermetaPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		isHighlightOccurrences = preferenceStore.getBoolean(org.kermeta.language.emftexteditor.ui.KermetaPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		definitionColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.kermeta.language.emftexteditor.ui.KermetaPreferenceConstants.EDITOR_DEFINITION_COLOR));
		proxyColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.kermeta.language.emftexteditor.ui.KermetaPreferenceConstants.EDITOR_PROXY_COLOR));
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.kermeta.language.emftexteditor.ui.KermetaPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.kermeta.language.emftexteditor.ui.KermetaEditor editor) {
	...
	private void setHighlighting() {
		...
		if (occurrence.isPositionsChanged()) {
			...
			org.kermeta.language.emftexteditor.ui.KermetaPositionCategory.DEFINTION.toString());
			setCategoryHighlighting(document,
			org.kermeta.language.emftexteditor.ui.KermetaPositionCategory.PROXY.toString());
		}
		setCategoryHighlighting(document, org.kermeta.language.emftexteditor.ui.KermetaPositionCategory.BRACKET.toString());
	}
	...
	private void setCategoryHighlighting(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.kermeta.language.emftexteditor.ui.KermetaPositionCategory.PROXY.toString())) {
		...
		for (org.eclipse.jface.text.Position position : positions) {
			...
			if (tmpPosition != null) {
				if (category.equals(org.kermeta.language.emftexteditor.ui.KermetaPositionCategory.DEFINTION.toString())) {
				...
				if (category.equals(org.kermeta.language.emftexteditor.ui.KermetaPositionCategory.BRACKET.toString())) {
					styleRange = getStyleRangeAtPosition(tmpPosition);
	...
	private void removeHighlighting() {
		org.eclipse.jface.text.IDocument document = projectionViewer.getDocument();
		removeHighlightingCategory(document, org.kermeta.language.emftexteditor.ui.KermetaPositionCategory.BRACKET.toString());
		if (occurrence.isToRemoveHighlighting()) {
			removeHighlightingCategory(document, org.kermeta.language.emftexteditor.ui.KermetaPositionCategory.DEFINTION.toString());
			removeHighlightingCategory(document, org.kermeta.language.emftexteditor.ui.KermetaPositionCategory.PROXY.toString());
			lastStyleRange = null;
		}
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, category);
		boolean isOccurrence = (category.equals(org.kermeta.language.emftexteditor.ui.KermetaPositionCategory.DEFINTION.toString()) || category.equals(org.kermeta.language.emftexteditor.ui.KermetaPositionCategory.PROXY.toString())) && lastStyleRange != null;
		if (category.equals(org.kermeta.language.emftexteditor.ui.KermetaPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.kermeta.language.emftexteditor.ui.KermetaEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
	...
	private void handleContentOutlineSelection(org.eclipse.jface.viewers.ISelection selection) {
		if (!selection.isEmpty()) {
			...
			if (selectedElement instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (resource instanceof org.kermeta.language.emftexteditor.IKermetaTextResource) {
