...
public class KermetaEditorConfiguration extends org.eclipse.jface.text.source.SourceViewerConfiguration {
	...
	private org.kermeta.language.emftexteditor.ui.KermetaEditor theEditor;
	...
	// @param colorManager
	///
	public KermetaEditorConfiguration(org.kermeta.language.emftexteditor.ui.KermetaEditor editor, org.kermeta.language.emftexteditor.ui.KermetaColorManager colorManager) {
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.kermeta.language.emftexteditor.ui.KermetaCompletionProcessor(theEditor), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.kermeta.language.emftexteditor.ui.KermetaTextHover(theEditor);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.kermeta.language.emftexteditor.ui.KermetaHyperlinkDetector(theEditor.getResource()) };
	}
