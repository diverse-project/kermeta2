/*$Id : KermetaNature.java 1.4 20 juil. 2010 17:13:42 hrambelo Exp $
...
public class KermetaNature implements IProjectNature {
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(KermetaBuilder.BUILDER_ID)) {
				return;
			}
		}
		...
		command.setBuilderName(KermetaBuilder.BUILDER_ID);
