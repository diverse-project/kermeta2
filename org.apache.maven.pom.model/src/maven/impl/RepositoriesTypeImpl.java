 ...
 * <ul>
 *   <li>{@link maven.impl.RepositoriesTypeImpl#getRepository <em>Repository</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RepositoriesTypeImpl extends EObjectImpl implements RepositoriesType {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.REPOSITORIES_TYPE;
	}
	...
	public EList<Repository> getRepository() {
		if (repository == null) {
			repository = new EObjectContainmentEList<Repository>(Repository.class, this, MavenPackage.REPOSITORIES_TYPE__REPOSITORY);
		}
		return repository;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MavenPackage.REPOSITORIES_TYPE__REPOSITORY:
