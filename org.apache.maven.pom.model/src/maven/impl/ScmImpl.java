 ...
 * <ul>
 *   <li>{@link maven.impl.ScmImpl#getConnection <em>Connection</em>}</li>
 *   <li>{@link maven.impl.ScmImpl#getDeveloperConnection <em>Developer Connection</em>}</li>
 *   <li>{@link maven.impl.ScmImpl#getTag <em>Tag</em>}</li>
 *   <li>{@link maven.impl.ScmImpl#getUrl <em>Url</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScmImpl extends EObjectImpl implements Scm {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.SCM;
	}
	...
	public void setConnection(String newConnection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.SCM__CONNECTION, oldConnection, connection));
	}
	...
	public void setDeveloperConnection(String newDeveloperConnection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.SCM__DEVELOPER_CONNECTION, oldDeveloperConnection, developerConnection));
	}
	...
	public void setTag(String newTag) {
		...
		tagESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.SCM__TAG, oldTag, tag, !oldTagESet));
	}
	...
	public void unsetTag() {
		...
		tagESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MavenPackage.SCM__TAG, oldTag, TAG_EDEFAULT, oldTagESet));
	}
	...
	public void setUrl(String newUrl) {
		...
		url = newUrl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.SCM__URL, oldUrl, url));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MavenPackage.SCM__CONNECTION:
				return getConnection();
			case MavenPackage.SCM__DEVELOPER_CONNECTION:
				return getDeveloperConnection();
			case MavenPackage.SCM__TAG:
				return getTag();
			case MavenPackage.SCM__URL:
				return getUrl();
		}
