 ...
 * <ul>
 *   <li>{@link maven.impl.ProfilesTypeImpl#getProfile <em>Profile</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProfilesTypeImpl extends EObjectImpl implements ProfilesType {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.PROFILES_TYPE;
	}
	...
	public EList<Profile> getProfile() {
		if (profile == null) {
			profile = new EObjectContainmentEList<Profile>(Profile.class, this, MavenPackage.PROFILES_TYPE__PROFILE);
		}
		return profile;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MavenPackage.PROFILES_TYPE__PROFILE:
