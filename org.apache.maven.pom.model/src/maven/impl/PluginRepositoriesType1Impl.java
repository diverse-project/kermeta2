 ...
 * <ul>
 *   <li>{@link maven.impl.PluginRepositoriesType1Impl#getPluginRepository <em>Plugin Repository</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PluginRepositoriesType1Impl extends EObjectImpl implements PluginRepositoriesType1 {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.PLUGIN_REPOSITORIES_TYPE1;
	}
	...
	public EList<Repository> getPluginRepository() {
		if (pluginRepository == null) {
			pluginRepository = new EObjectContainmentEList<Repository>(Repository.class, this, MavenPackage.PLUGIN_REPOSITORIES_TYPE1__PLUGIN_REPOSITORY);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MavenPackage.PLUGIN_REPOSITORIES_TYPE1__PLUGIN_REPOSITORY:
