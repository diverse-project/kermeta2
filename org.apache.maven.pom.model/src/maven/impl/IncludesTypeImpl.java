 ...
 * <ul>
 *   <li>{@link maven.impl.IncludesTypeImpl#getInclude <em>Include</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IncludesTypeImpl extends EObjectImpl implements IncludesType {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.INCLUDES_TYPE;
	}
	...
	public EList<String> getInclude() {
		if (include == null) {
			include = new EDataTypeEList<String>(String.class, this, MavenPackage.INCLUDES_TYPE__INCLUDE);
		}
		return include;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MavenPackage.INCLUDES_TYPE__INCLUDE:
				return getInclude();
		}
