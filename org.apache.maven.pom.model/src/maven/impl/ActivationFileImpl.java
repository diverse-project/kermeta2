 ...
 * <ul>
 *   <li>{@link maven.impl.ActivationFileImpl#getMissing <em>Missing</em>}</li>
 *   <li>{@link maven.impl.ActivationFileImpl#getExists <em>Exists</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActivationFileImpl extends EObjectImpl implements ActivationFile {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.ACTIVATION_FILE;
	}
	...
	public void setMissing(String newMissing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.ACTIVATION_FILE__MISSING, oldMissing, missing));
	}
	...
	public void setExists(String newExists) {
		...
		exists = newExists;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.ACTIVATION_FILE__EXISTS, oldExists, exists));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MavenPackage.ACTIVATION_FILE__MISSING:
				return getMissing();
			case MavenPackage.ACTIVATION_FILE__EXISTS:
				return getExists();
		}
