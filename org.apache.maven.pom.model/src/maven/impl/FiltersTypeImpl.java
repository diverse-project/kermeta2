 ...
 * <ul>
 *   <li>{@link maven.impl.FiltersTypeImpl#getFilter <em>Filter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FiltersTypeImpl extends EObjectImpl implements FiltersType {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.FILTERS_TYPE;
	}
	...
	public EList<String> getFilter() {
		if (filter == null) {
			filter = new EDataTypeEList<String>(String.class, this, MavenPackage.FILTERS_TYPE__FILTER);
		}
		return filter;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MavenPackage.FILTERS_TYPE__FILTER:
				return getFilter();
		}
