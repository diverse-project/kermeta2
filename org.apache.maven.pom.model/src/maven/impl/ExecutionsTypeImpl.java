 ...
 * <ul>
 *   <li>{@link maven.impl.ExecutionsTypeImpl#getExecution <em>Execution</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExecutionsTypeImpl extends EObjectImpl implements ExecutionsType {
	...
	public EList<PluginExecution> getExecution() {
		if (execution == null) {
			execution = new EObjectContainmentEList<PluginExecution>(PluginExecution.class, this, MavenPackage.EXECUTIONS_TYPE__EXECUTION);
		}
		return execution;
	}
