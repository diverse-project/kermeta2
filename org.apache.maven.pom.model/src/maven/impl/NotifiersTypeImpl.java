 ...
 * <ul>
 *   <li>{@link maven.impl.NotifiersTypeImpl#getNotifier <em>Notifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NotifiersTypeImpl extends EObjectImpl implements NotifiersType {
	...
	public EList<Notifier> getNotifier() {
		if (notifier == null) {
			notifier = new EObjectContainmentEList<Notifier>(Notifier.class, this, MavenPackage.NOTIFIERS_TYPE__NOTIFIER);
		}
		return notifier;
	}
