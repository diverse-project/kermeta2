 ...
 * <ul>
 *   <li>{@link maven.impl.PrerequisitesImpl#getMaven <em>Maven</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrerequisitesImpl extends EObjectImpl implements Prerequisites {
	...
	public void setMaven(String newMaven) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.PREREQUISITES__MAVEN, oldMaven, maven, !oldMavenESet));
	}
	...
	public void unsetMaven() {
		...
		mavenESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MavenPackage.PREREQUISITES__MAVEN, oldMaven, MAVEN_EDEFAULT, oldMavenESet));
	}
