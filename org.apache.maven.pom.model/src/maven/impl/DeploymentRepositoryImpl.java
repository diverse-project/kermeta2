 ...
 * <ul>
 *   <li>{@link maven.impl.DeploymentRepositoryImpl#isUniqueVersion <em>Unique Version</em>}</li>
 *   <li>{@link maven.impl.DeploymentRepositoryImpl#getId <em>Id</em>}</li>
 *   <li>{@link maven.impl.DeploymentRepositoryImpl#getName <em>Name</em>}</li>
 *   <li>{@link maven.impl.DeploymentRepositoryImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link maven.impl.DeploymentRepositoryImpl#getLayout <em>Layout</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeploymentRepositoryImpl extends EObjectImpl implements DeploymentRepository {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.DEPLOYMENT_REPOSITORY;
	}
	...
	public void setUniqueVersion(boolean newUniqueVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.DEPLOYMENT_REPOSITORY__UNIQUE_VERSION, oldUniqueVersion, uniqueVersion, !oldUniqueVersionESet));
	}
	...
	public void unsetUniqueVersion() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MavenPackage.DEPLOYMENT_REPOSITORY__UNIQUE_VERSION, oldUniqueVersion, UNIQUE_VERSION_EDEFAULT, oldUniqueVersionESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.DEPLOYMENT_REPOSITORY__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.DEPLOYMENT_REPOSITORY__NAME, oldName, name));
	}
	...
	public void setUrl(String newUrl) {
		...
		url = newUrl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.DEPLOYMENT_REPOSITORY__URL, oldUrl, url));
	}
	...
	public void setLayout(String newLayout) {
		...
		layoutESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.DEPLOYMENT_REPOSITORY__LAYOUT, oldLayout, layout, !oldLayoutESet));
	}
	...
	public void unsetLayout() {
		...
		layoutESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MavenPackage.DEPLOYMENT_REPOSITORY__LAYOUT, oldLayout, LAYOUT_EDEFAULT, oldLayoutESet));
	}
