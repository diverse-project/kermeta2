 ...
 * <ul>
 *   <li>{@link maven.impl.PluginsType2Impl#getPlugin <em>Plugin</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PluginsType2Impl extends EObjectImpl implements PluginsType2 {
	/**
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.PLUGINS_TYPE2;
	}
	...
	public EList<Plugin> getPlugin() {
		if (plugin == null) {
			plugin = new EObjectContainmentEList<Plugin>(Plugin.class, this, MavenPackage.PLUGINS_TYPE2__PLUGIN);
		}
		return plugin;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MavenPackage.PLUGINS_TYPE2__PLUGIN:
