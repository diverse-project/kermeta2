 ...
 * <ul>
 *   <li>{@link maven.impl.LicenseImpl#getName <em>Name</em>}</li>
 *   <li>{@link maven.impl.LicenseImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link maven.impl.LicenseImpl#getDistribution <em>Distribution</em>}</li>
 *   <li>{@link maven.impl.LicenseImpl#getComments <em>Comments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LicenseImpl extends EObjectImpl implements License {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.LICENSE__NAME, oldName, name));
	}
	...
	public void setUrl(String newUrl) {
		...
		url = newUrl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.LICENSE__URL, oldUrl, url));
	}
	...
	public void setDistribution(String newDistribution) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.LICENSE__DISTRIBUTION, oldDistribution, distribution));
	}
	...
	public void setComments(String newComments) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.LICENSE__COMMENTS, oldComments, comments));
	}
