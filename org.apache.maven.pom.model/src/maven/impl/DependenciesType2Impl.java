 ...
 * <ul>
 *   <li>{@link maven.impl.DependenciesType2Impl#getDependency <em>Dependency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DependenciesType2Impl extends EObjectImpl implements DependenciesType2 {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.DEPENDENCIES_TYPE2;
	}
	...
	public EList<Dependency> getDependency() {
		if (dependency == null) {
			dependency = new EObjectContainmentEList<Dependency>(Dependency.class, this, MavenPackage.DEPENDENCIES_TYPE2__DEPENDENCY);
		}
		return dependency;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MavenPackage.DEPENDENCIES_TYPE2__DEPENDENCY:
