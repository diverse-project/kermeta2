 ...
 * <ul>
 *   <li>{@link maven.impl.MailingListImpl#getName <em>Name</em>}</li>
 *   <li>{@link maven.impl.MailingListImpl#getSubscribe <em>Subscribe</em>}</li>
 *   <li>{@link maven.impl.MailingListImpl#getUnsubscribe <em>Unsubscribe</em>}</li>
 *   <li>{@link maven.impl.MailingListImpl#getPost <em>Post</em>}</li>
 *   <li>{@link maven.impl.MailingListImpl#getArchive <em>Archive</em>}</li>
 *   <li>{@link maven.impl.MailingListImpl#getOtherArchives <em>Other Archives</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MailingListImpl extends EObjectImpl implements MailingList {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.MAILING_LIST;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.MAILING_LIST__NAME, oldName, name));
	}
	...
	public void setSubscribe(String newSubscribe) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.MAILING_LIST__SUBSCRIBE, oldSubscribe, subscribe));
	}
	...
	public void setUnsubscribe(String newUnsubscribe) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.MAILING_LIST__UNSUBSCRIBE, oldUnsubscribe, unsubscribe));
	}
	...
	public void setPost(String newPost) {
		...
		post = newPost;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.MAILING_LIST__POST, oldPost, post));
	}
	...
	public void setArchive(String newArchive) {
		...
		archive = newArchive;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.MAILING_LIST__ARCHIVE, oldArchive, archive));
	}
	...
	public NotificationChain basicSetOtherArchives(OtherArchivesType newOtherArchives, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MavenPackage.MAILING_LIST__OTHER_ARCHIVES, oldOtherArchives, newOtherArchives);
	...
	public void setOtherArchives(OtherArchivesType newOtherArchives) {
		if (newOtherArchives != otherArchives) {
			...
			if (otherArchives != null)
				msgs = ((InternalEObject)otherArchives).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MavenPackage.MAILING_LIST__OTHER_ARCHIVES, null, msgs);
			if (newOtherArchives != null)
				msgs = ((InternalEObject)newOtherArchives).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MavenPackage.MAILING_LIST__OTHER_ARCHIVES, null, msgs);
			msgs = basicSetOtherArchives(newOtherArchives, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.MAILING_LIST__OTHER_ARCHIVES, newOtherArchives, newOtherArchives));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MavenPackage.MAILING_LIST__OTHER_ARCHIVES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MavenPackage.MAILING_LIST__NAME:
				return getName();
			case MavenPackage.MAILING_LIST__SUBSCRIBE:
				return getSubscribe();
			case MavenPackage.MAILING_LIST__UNSUBSCRIBE:
				return getUnsubscribe();
			case MavenPackage.MAILING_LIST__POST:
				return getPost();
			case MavenPackage.MAILING_LIST__ARCHIVE:
				return getArchive();
			case MavenPackage.MAILING_LIST__OTHER_ARCHIVES:
