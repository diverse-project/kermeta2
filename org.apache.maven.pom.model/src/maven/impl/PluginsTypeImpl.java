 ...
 * <ul>
 *   <li>{@link maven.impl.PluginsTypeImpl#getPlugin <em>Plugin</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PluginsTypeImpl extends EObjectImpl implements PluginsType {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.PLUGINS_TYPE;
	}
	...
	public EList<Plugin> getPlugin() {
		if (plugin == null) {
			plugin = new EObjectContainmentEList<Plugin>(Plugin.class, this, MavenPackage.PLUGINS_TYPE__PLUGIN);
		}
		return plugin;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MavenPackage.PLUGINS_TYPE__PLUGIN:
