 ...
 * <ul>
 *   <li>{@link maven.impl.BuildImpl#getSourceDirectory <em>Source Directory</em>}</li>
 *   <li>{@link maven.impl.BuildImpl#getScriptSourceDirectory <em>Script Source Directory</em>}</li>
 *   <li>{@link maven.impl.BuildImpl#getTestSourceDirectory <em>Test Source Directory</em>}</li>
 *   <li>{@link maven.impl.BuildImpl#getOutputDirectory <em>Output Directory</em>}</li>
 *   <li>{@link maven.impl.BuildImpl#getTestOutputDirectory <em>Test Output Directory</em>}</li>
 *   <li>{@link maven.impl.BuildImpl#getExtensions <em>Extensions</em>}</li>
 *   <li>{@link maven.impl.BuildImpl#getDefaultGoal <em>Default Goal</em>}</li>
 *   <li>{@link maven.impl.BuildImpl#getResources <em>Resources</em>}</li>
 *   <li>{@link maven.impl.BuildImpl#getTestResources <em>Test Resources</em>}</li>
 *   <li>{@link maven.impl.BuildImpl#getDirectory <em>Directory</em>}</li>
 *   <li>{@link maven.impl.BuildImpl#getFinalName <em>Final Name</em>}</li>
 *   <li>{@link maven.impl.BuildImpl#getFilters <em>Filters</em>}</li>
 *   <li>{@link maven.impl.BuildImpl#getPluginManagement <em>Plugin Management</em>}</li>
 *   <li>{@link maven.impl.BuildImpl#getPlugins <em>Plugins</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BuildImpl extends EObjectImpl implements Build {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.BUILD;
	}
	...
	public void setSourceDirectory(String newSourceDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__SOURCE_DIRECTORY, oldSourceDirectory, sourceDirectory));
	}
	...
	public void setScriptSourceDirectory(String newScriptSourceDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__SCRIPT_SOURCE_DIRECTORY, oldScriptSourceDirectory, scriptSourceDirectory));
	}
	...
	public void setTestSourceDirectory(String newTestSourceDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__TEST_SOURCE_DIRECTORY, oldTestSourceDirectory, testSourceDirectory));
	}
	...
	public void setOutputDirectory(String newOutputDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__OUTPUT_DIRECTORY, oldOutputDirectory, outputDirectory));
	}
	...
	public void setTestOutputDirectory(String newTestOutputDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__TEST_OUTPUT_DIRECTORY, oldTestOutputDirectory, testOutputDirectory));
	}
	...
	public NotificationChain basicSetExtensions(ExtensionsType newExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__EXTENSIONS, oldExtensions, newExtensions);
	...
	public void setExtensions(ExtensionsType newExtensions) {
		if (newExtensions != extensions) {
			...
			if (extensions != null)
				msgs = ((InternalEObject)extensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MavenPackage.BUILD__EXTENSIONS, null, msgs);
			if (newExtensions != null)
				msgs = ((InternalEObject)newExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MavenPackage.BUILD__EXTENSIONS, null, msgs);
			msgs = basicSetExtensions(newExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__EXTENSIONS, newExtensions, newExtensions));
	}
	...
	public void setDefaultGoal(String newDefaultGoal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__DEFAULT_GOAL, oldDefaultGoal, defaultGoal));
	}
	...
	public NotificationChain basicSetResources(ResourcesType1 newResources, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__RESOURCES, oldResources, newResources);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setResources(ResourcesType1 newResources) {
		if (newResources != resources) {
			NotificationChain msgs = null;
			if (resources != null)
				msgs = ((InternalEObject)resources).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MavenPackage.BUILD__RESOURCES, null, msgs);
			if (newResources != null)
				msgs = ((InternalEObject)newResources).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MavenPackage.BUILD__RESOURCES, null, msgs);
			msgs = basicSetResources(newResources, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__RESOURCES, newResources, newResources));
	}
	...
	public NotificationChain basicSetTestResources(TestResourcesType1 newTestResources, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__TEST_RESOURCES, oldTestResources, newTestResources);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTestResources(TestResourcesType1 newTestResources) {
		if (newTestResources != testResources) {
			...
			if (testResources != null)
				msgs = ((InternalEObject)testResources).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MavenPackage.BUILD__TEST_RESOURCES, null, msgs);
			if (newTestResources != null)
				msgs = ((InternalEObject)newTestResources).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MavenPackage.BUILD__TEST_RESOURCES, null, msgs);
			msgs = basicSetTestResources(newTestResources, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__TEST_RESOURCES, newTestResources, newTestResources));
	}
	...
	public void setDirectory(String newDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__DIRECTORY, oldDirectory, directory));
	}
	...
	public void setFinalName(String newFinalName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__FINAL_NAME, oldFinalName, finalName));
	}
	...
	public NotificationChain basicSetFilters(FiltersType1 newFilters, NotificationChain msgs) {
		...
		filters = newFilters;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__FILTERS, oldFilters, newFilters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFilters(FiltersType1 newFilters) {
		if (newFilters != filters) {
			NotificationChain msgs = null;
			if (filters != null)
				msgs = ((InternalEObject)filters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MavenPackage.BUILD__FILTERS, null, msgs);
			if (newFilters != null)
				msgs = ((InternalEObject)newFilters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MavenPackage.BUILD__FILTERS, null, msgs);
			msgs = basicSetFilters(newFilters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__FILTERS, newFilters, newFilters));
	}
	...
	public NotificationChain basicSetPluginManagement(PluginManagement newPluginManagement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__PLUGIN_MANAGEMENT, oldPluginManagement, newPluginManagement);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPluginManagement(PluginManagement newPluginManagement) {
		if (newPluginManagement != pluginManagement) {
			...
			if (pluginManagement != null)
				msgs = ((InternalEObject)pluginManagement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MavenPackage.BUILD__PLUGIN_MANAGEMENT, null, msgs);
			if (newPluginManagement != null)
				msgs = ((InternalEObject)newPluginManagement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MavenPackage.BUILD__PLUGIN_MANAGEMENT, null, msgs);
			msgs = basicSetPluginManagement(newPluginManagement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__PLUGIN_MANAGEMENT, newPluginManagement, newPluginManagement));
	}
	...
	public NotificationChain basicSetPlugins(PluginsType2 newPlugins, NotificationChain msgs) {
		...
		plugins = newPlugins;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__PLUGINS, oldPlugins, newPlugins);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPlugins(PluginsType2 newPlugins) {
		if (newPlugins != plugins) {
			NotificationChain msgs = null;
			if (plugins != null)
				msgs = ((InternalEObject)plugins).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MavenPackage.BUILD__PLUGINS, null, msgs);
			if (newPlugins != null)
				msgs = ((InternalEObject)newPlugins).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MavenPackage.BUILD__PLUGINS, null, msgs);
			msgs = basicSetPlugins(newPlugins, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.BUILD__PLUGINS, newPlugins, newPlugins));
	}
