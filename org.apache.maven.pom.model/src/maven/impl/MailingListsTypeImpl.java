 ...
 * <ul>
 *   <li>{@link maven.impl.MailingListsTypeImpl#getMailingList <em>Mailing List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MailingListsTypeImpl extends EObjectImpl implements MailingListsType {
	...
	public EList<MailingList> getMailingList() {
		if (mailingList == null) {
			mailingList = new EObjectContainmentEList<MailingList>(MailingList.class, this, MavenPackage.MAILING_LISTS_TYPE__MAILING_LIST);
		}
		return mailingList;
	}
