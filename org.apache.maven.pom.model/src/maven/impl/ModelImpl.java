 ...
 * <ul>
 *   <li>{@link maven.impl.ModelImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getModelVersion <em>Model Version</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getGroupId <em>Group Id</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getArtifactId <em>Artifact Id</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getPackaging <em>Packaging</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getName <em>Name</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getPrerequisites <em>Prerequisites</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getIssueManagement <em>Issue Management</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getCiManagement <em>Ci Management</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getInceptionYear <em>Inception Year</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getMailingLists <em>Mailing Lists</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getDevelopers <em>Developers</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getContributors <em>Contributors</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getLicenses <em>Licenses</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getScm <em>Scm</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getBuild <em>Build</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getProfiles <em>Profiles</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getModules <em>Modules</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getRepositories <em>Repositories</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getPluginRepositories <em>Plugin Repositories</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getDependencies <em>Dependencies</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getReports <em>Reports</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getReporting <em>Reporting</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getDependencyManagement <em>Dependency Management</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getDistributionManagement <em>Distribution Management</em>}</li>
 *   <li>{@link maven.impl.ModelImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
