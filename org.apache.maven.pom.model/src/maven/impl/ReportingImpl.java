 ...
 * <ul>
 *   <li>{@link maven.impl.ReportingImpl#isExcludeDefaults <em>Exclude Defaults</em>}</li>
 *   <li>{@link maven.impl.ReportingImpl#getOutputDirectory <em>Output Directory</em>}</li>
 *   <li>{@link maven.impl.ReportingImpl#getPlugins <em>Plugins</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReportingImpl extends EObjectImpl implements Reporting {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.REPORTING;
	}
	...
	public void setExcludeDefaults(boolean newExcludeDefaults) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.REPORTING__EXCLUDE_DEFAULTS, oldExcludeDefaults, excludeDefaults, !oldExcludeDefaultsESet));
	}
	...
	public void unsetExcludeDefaults() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MavenPackage.REPORTING__EXCLUDE_DEFAULTS, oldExcludeDefaults, EXCLUDE_DEFAULTS_EDEFAULT, oldExcludeDefaultsESet));
	}
	...
	public void setOutputDirectory(String newOutputDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.REPORTING__OUTPUT_DIRECTORY, oldOutputDirectory, outputDirectory));
	}
	...
	public NotificationChain basicSetPlugins(PluginsType1 newPlugins, NotificationChain msgs) {
		...
		plugins = newPlugins;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MavenPackage.REPORTING__PLUGINS, oldPlugins, newPlugins);
	...
	public void setPlugins(PluginsType1 newPlugins) {
		if (newPlugins != plugins) {
			...
			if (plugins != null)
				msgs = ((InternalEObject)plugins).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MavenPackage.REPORTING__PLUGINS, null, msgs);
			if (newPlugins != null)
				msgs = ((InternalEObject)newPlugins).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MavenPackage.REPORTING__PLUGINS, null, msgs);
			msgs = basicSetPlugins(newPlugins, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.REPORTING__PLUGINS, newPlugins, newPlugins));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MavenPackage.REPORTING__PLUGINS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MavenPackage.REPORTING__EXCLUDE_DEFAULTS:
				return isExcludeDefaults();
			case MavenPackage.REPORTING__OUTPUT_DIRECTORY:
