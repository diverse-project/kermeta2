 ...
 * <ul>
 *   <li>{@link maven.impl.ActivationImpl#isActiveByDefault <em>Active By Default</em>}</li>
 *   <li>{@link maven.impl.ActivationImpl#getJdk <em>Jdk</em>}</li>
 *   <li>{@link maven.impl.ActivationImpl#getOs <em>Os</em>}</li>
 *   <li>{@link maven.impl.ActivationImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link maven.impl.ActivationImpl#getFile <em>File</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActivationImpl extends EObjectImpl implements Activation {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.ACTIVATION;
	}
	...
	public void setActiveByDefault(boolean newActiveByDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.ACTIVATION__ACTIVE_BY_DEFAULT, oldActiveByDefault, activeByDefault, !oldActiveByDefaultESet));
	}
	...
	public void unsetActiveByDefault() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MavenPackage.ACTIVATION__ACTIVE_BY_DEFAULT, oldActiveByDefault, ACTIVE_BY_DEFAULT_EDEFAULT, oldActiveByDefaultESet));
	}
	...
	public void setJdk(String newJdk) {
		...
		jdk = newJdk;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.ACTIVATION__JDK, oldJdk, jdk));
	}
	...
	public NotificationChain basicSetOs(ActivationOS newOs, NotificationChain msgs) {
		...
		os = newOs;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MavenPackage.ACTIVATION__OS, oldOs, newOs);
	...
	public void setOs(ActivationOS newOs) {
		if (newOs != os) {
			...
			if (os != null)
				msgs = ((InternalEObject)os).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MavenPackage.ACTIVATION__OS, null, msgs);
			if (newOs != null)
				msgs = ((InternalEObject)newOs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MavenPackage.ACTIVATION__OS, null, msgs);
			msgs = basicSetOs(newOs, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.ACTIVATION__OS, newOs, newOs));
	}
	...
	public NotificationChain basicSetProperty(ActivationProperty newProperty, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MavenPackage.ACTIVATION__PROPERTY, oldProperty, newProperty);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProperty(ActivationProperty newProperty) {
		if (newProperty != property) {
			NotificationChain msgs = null;
			if (property != null)
				msgs = ((InternalEObject)property).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MavenPackage.ACTIVATION__PROPERTY, null, msgs);
			if (newProperty != null)
				msgs = ((InternalEObject)newProperty).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MavenPackage.ACTIVATION__PROPERTY, null, msgs);
			msgs = basicSetProperty(newProperty, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.ACTIVATION__PROPERTY, newProperty, newProperty));
	}
	...
	public NotificationChain basicSetFile(ActivationFile newFile, NotificationChain msgs) {
		...
		file = newFile;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MavenPackage.ACTIVATION__FILE, oldFile, newFile);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFile(ActivationFile newFile) {
		if (newFile != file) {
			NotificationChain msgs = null;
			if (file != null)
				msgs = ((InternalEObject)file).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MavenPackage.ACTIVATION__FILE, null, msgs);
			if (newFile != null)
				msgs = ((InternalEObject)newFile).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MavenPackage.ACTIVATION__FILE, null, msgs);
			msgs = basicSetFile(newFile, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.ACTIVATION__FILE, newFile, newFile));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MavenPackage.ACTIVATION__OS:
				return basicSetOs(null, msgs);
			case MavenPackage.ACTIVATION__PROPERTY:
				return basicSetProperty(null, msgs);
			case MavenPackage.ACTIVATION__FILE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MavenPackage.ACTIVATION__ACTIVE_BY_DEFAULT:
				return isActiveByDefault();
			case MavenPackage.ACTIVATION__JDK:
				return getJdk();
			case MavenPackage.ACTIVATION__OS:
				return getOs();
			case MavenPackage.ACTIVATION__PROPERTY:
