 ...
 * <ul>
 *   <li>{@link maven.impl.PluginsType1Impl#getPlugin <em>Plugin</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PluginsType1Impl extends EObjectImpl implements PluginsType1 {
	...
	public EList<ReportPlugin> getPlugin() {
		if (plugin == null) {
			plugin = new EObjectContainmentEList<ReportPlugin>(ReportPlugin.class, this, MavenPackage.PLUGINS_TYPE1__PLUGIN);
		}
		return plugin;
	}
