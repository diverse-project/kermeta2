 ...
 * <ul>
 *   <li>{@link maven.impl.ResourcesTypeImpl#getResource <em>Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourcesTypeImpl extends EObjectImpl implements ResourcesType {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.RESOURCES_TYPE;
	}
	...
	public EList<Resource> getResource() {
		if (resource == null) {
			resource = new EObjectContainmentEList<Resource>(Resource.class, this, MavenPackage.RESOURCES_TYPE__RESOURCE);
		}
		return resource;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MavenPackage.RESOURCES_TYPE__RESOURCE:
