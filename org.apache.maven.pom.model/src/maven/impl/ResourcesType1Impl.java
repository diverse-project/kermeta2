 ...
 * <ul>
 *   <li>{@link maven.impl.ResourcesType1Impl#getResource <em>Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourcesType1Impl extends EObjectImpl implements ResourcesType1 {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.RESOURCES_TYPE1;
	}
	...
	public EList<Resource> getResource() {
		if (resource == null) {
			resource = new EObjectContainmentEList<Resource>(Resource.class, this, MavenPackage.RESOURCES_TYPE1__RESOURCE);
		}
		return resource;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MavenPackage.RESOURCES_TYPE1__RESOURCE:
