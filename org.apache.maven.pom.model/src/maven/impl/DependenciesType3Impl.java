 ...
 * <ul>
 *   <li>{@link maven.impl.DependenciesType3Impl#getDependency <em>Dependency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DependenciesType3Impl extends EObjectImpl implements DependenciesType3 {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.DEPENDENCIES_TYPE3;
	}
	...
	public EList<Dependency> getDependency() {
		if (dependency == null) {
			dependency = new EObjectContainmentEList<Dependency>(Dependency.class, this, MavenPackage.DEPENDENCIES_TYPE3__DEPENDENCY);
		}
		return dependency;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MavenPackage.DEPENDENCIES_TYPE3__DEPENDENCY:
