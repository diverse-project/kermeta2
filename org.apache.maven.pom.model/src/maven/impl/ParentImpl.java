 ...
 * <ul>
 *   <li>{@link maven.impl.ParentImpl#getArtifactId <em>Artifact Id</em>}</li>
 *   <li>{@link maven.impl.ParentImpl#getGroupId <em>Group Id</em>}</li>
 *   <li>{@link maven.impl.ParentImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link maven.impl.ParentImpl#getRelativePath <em>Relative Path</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParentImpl extends EObjectImpl implements Parent {
	...
	public void setArtifactId(String newArtifactId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.PARENT__ARTIFACT_ID, oldArtifactId, artifactId));
	}
	...
	public void setGroupId(String newGroupId) {
		...
		groupId = newGroupId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.PARENT__GROUP_ID, oldGroupId, groupId));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.PARENT__VERSION, oldVersion, version));
	}
	...
	public void setRelativePath(String newRelativePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MavenPackage.PARENT__RELATIVE_PATH, oldRelativePath, relativePath, !oldRelativePathESet));
	}
	...
	public void unsetRelativePath() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MavenPackage.PARENT__RELATIVE_PATH, oldRelativePath, RELATIVE_PATH_EDEFAULT, oldRelativePathESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MavenPackage.PARENT__ARTIFACT_ID:
				return getArtifactId();
			case MavenPackage.PARENT__GROUP_ID:
				return getGroupId();
			case MavenPackage.PARENT__VERSION:
				return getVersion();
