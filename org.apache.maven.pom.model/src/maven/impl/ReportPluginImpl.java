 ...
 * <ul>
 *   <li>{@link maven.impl.ReportPluginImpl#getGroupId <em>Group Id</em>}</li>
 *   <li>{@link maven.impl.ReportPluginImpl#getArtifactId <em>Artifact Id</em>}</li>
 *   <li>{@link maven.impl.ReportPluginImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link maven.impl.ReportPluginImpl#getInherited <em>Inherited</em>}</li>
 *   <li>{@link maven.impl.ReportPluginImpl#getConfiguration <em>Configuration</em>}</li>
 *   <li>{@link maven.impl.ReportPluginImpl#getReportSets <em>Report Sets</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
