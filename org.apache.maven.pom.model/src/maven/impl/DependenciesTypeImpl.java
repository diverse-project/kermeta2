 ...
 * <ul>
 *   <li>{@link maven.impl.DependenciesTypeImpl#getDependency <em>Dependency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DependenciesTypeImpl extends EObjectImpl implements DependenciesType {
	...
	public EList<Dependency> getDependency() {
		if (dependency == null) {
			dependency = new EObjectContainmentEList<Dependency>(Dependency.class, this, MavenPackage.DEPENDENCIES_TYPE__DEPENDENCY);
		}
		return dependency;
	}
