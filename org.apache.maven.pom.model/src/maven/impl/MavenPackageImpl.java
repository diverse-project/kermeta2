...
import maven.ActivationFile;
import maven.ActivationOS;
import maven.ActivationProperty;
import maven.Build;
import maven.BuildBase;
import maven.CiManagement;
import maven.ConfigurationType;
import maven.ConfigurationType1;
import maven.ConfigurationType2;
import maven.ConfigurationType3;
import maven.ConfigurationType4;
import maven.Contributor;
import maven.ContributorsType;
import maven.DependenciesType;
...
import maven.ExtensionsType;
import maven.FiltersType;
import maven.FiltersType1;
import maven.GoalsType;
import maven.GoalsType1;
import maven.IncludesType;
import maven.IssueManagement;
import maven.License;
import maven.LicensesType;
import maven.MailingList;
import maven.MailingListsType;
import maven.MavenFactory;
import maven.MavenPackage;
import maven.Model;
import maven.ModulesType;
import maven.ModulesType1;
import maven.Notifier;
import maven.NotifiersType;
import maven.Organization;
import maven.OtherArchivesType;
import maven.Parent;
import maven.Plugin;
import maven.PluginExecution;
import maven.PluginManagement;
import maven.PluginRepositoriesType;
import maven.PluginRepositoriesType1;
import maven.PluginsType;
import maven.PluginsType1;
import maven.PluginsType2;
import maven.PluginsType3;
import maven.Prerequisites;
import maven.Profile;
import maven.ProfilesType;
import maven.PropertiesType;
import maven.PropertiesType1;
import maven.PropertiesType2;
import maven.PropertiesType3;
import maven.Relocation;
import maven.ReportPlugin;
import maven.ReportSet;
import maven.ReportSetsType;
import maven.Reporting;
import maven.ReportsType;
import maven.ReportsType1;
import maven.ReportsType2;
import maven.RepositoriesType;
import maven.RepositoriesType1;
import maven.Repository;
import maven.RepositoryPolicy;
import maven.Resource;
import maven.ResourcesType;
import maven.ResourcesType1;
import maven.RolesType;
import maven.RolesType1;
import maven.Scm;
import maven.Site;
import maven.TestResourcesType;
import maven.TestResourcesType1;
...
public class MavenPackageImpl extends EPackageImpl implements MavenPackage {
	 ...
	 * @see maven.MavenPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getBuild_Plugins(), this.getPluginsType2(), null, "plugins", null, 0, 1, Build.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getContributor_Properties(), this.getPropertiesType(), null, "properties", null, 0, 1, Contributor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDependency_Optional(), theXMLTypePackage.getBoolean(), "optional", "false", 0, 1, Dependency.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDependencyManagement_Dependencies(), this.getDependenciesType1(), null, "dependencies", null, 0, 1, DependencyManagement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getModel_Modules(), this.getModulesType(), null, "modules", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModel_Repositories(), this.getRepositoriesType(), null, "repositories", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModel_PluginRepositories(), this.getPluginRepositoriesType(), null, "pluginRepositories", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModel_Dependencies(), this.getDependenciesType(), null, "dependencies", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModel_Reports(), this.getReportsType1(), null, "reports", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getModel_Properties(), this.getPropertiesType2(), null, "properties", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPlugin_Extensions(), theXMLTypePackage.getBoolean(), "extensions", "false", 0, 1, Plugin.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPlugin_Dependencies(), this.getDependenciesType3(), null, "dependencies", null, 0, 1, Plugin.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPlugin_Configuration(), this.getConfigurationType2(), null, "configuration", null, 0, 1, Plugin.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPluginsType1_Plugin(), this.getReportPlugin(), null, "plugin", null, 0, -1, PluginsType1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(pluginsType2EClass, PluginsType2.class, "PluginsType2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPluginsType2_Plugin(), this.getPlugin(), null, "plugin", null, 0, -1, PluginsType2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getProfile_Modules(), this.getModulesType1(), null, "modules", null, 0, 1, Profile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProfile_Repositories(), this.getRepositoriesType1(), null, "repositories", null, 0, 1, Profile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProfile_PluginRepositories(), this.getPluginRepositoriesType1(), null, "pluginRepositories", null, 0, 1, Profile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProfile_Dependencies(), this.getDependenciesType2(), null, "dependencies", null, 0, 1, Profile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProfile_Reports(), this.getReportsType2(), null, "reports", null, 0, 1, Profile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getReporting_ExcludeDefaults(), theXMLTypePackage.getBoolean(), "excludeDefaults", "false", 0, 1, Reporting.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getReporting_Plugins(), this.getPluginsType1(), null, "plugins", null, 0, 1, Reporting.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getReportPlugin_Configuration(), this.getConfigurationType(), null, "configuration", null, 0, 1, ReportPlugin.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getReportSet_Configuration(), this.getConfigurationType1(), null, "configuration", null, 0, 1, ReportSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRepositoryPolicy_Enabled(), theXMLTypePackage.getBoolean(), "enabled", "true", 0, 1, RepositoryPolicy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getResource_Filtering(), theXMLTypePackage.getBoolean(), "filtering", "false", 0, 1, Resource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
