 ...
 * <ul>
 *   <li>{@link maven.impl.ExtensionsTypeImpl#getExtension <em>Extension</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExtensionsTypeImpl extends EObjectImpl implements ExtensionsType {
	...
	protected EClass eStaticClass() {
		return MavenPackage.Literals.EXTENSIONS_TYPE;
	}
	...
	public EList<Extension> getExtension() {
		if (extension == null) {
			extension = new EObjectContainmentEList<Extension>(Extension.class, this, MavenPackage.EXTENSIONS_TYPE__EXTENSION);
		}
		return extension;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MavenPackage.EXTENSIONS_TYPE__EXTENSION:
