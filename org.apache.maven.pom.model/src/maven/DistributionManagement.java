 ...
 * <ul>
 *   <li>{@link maven.DistributionManagement#getRepository <em>Repository</em>}</li>
 *   <li>{@link maven.DistributionManagement#getSnapshotRepository <em>Snapshot Repository</em>}</li>
 *   <li>{@link maven.DistributionManagement#getSite <em>Site</em>}</li>
 *   <li>{@link maven.DistributionManagement#getDownloadUrl <em>Download Url</em>}</li>
 *   <li>{@link maven.DistributionManagement#getRelocation <em>Relocation</em>}</li>
 *   <li>{@link maven.DistributionManagement#getStatus <em>Status</em>}</li>
 * </ul>
 * </p>
 *
 * @see maven.MavenPackage#getDistributionManagement()
...
public interface DistributionManagement extends EObject {
	 ...
	 * @see maven.MavenPackage#getDistributionManagement_Repository()
	...
	/**
	 * Sets the value of the '{@link maven.DistributionManagement#getRepository <em>Repository</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see maven.MavenPackage#getDistributionManagement_SnapshotRepository()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link maven.DistributionManagement#getSnapshotRepository <em>Snapshot Repository</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setSite(Site)
	 * @see maven.MavenPackage#getDistributionManagement_Site()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link maven.DistributionManagement#getSite <em>Site</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see maven.MavenPackage#getDistributionManagement_DownloadUrl()
	...
	/**
	 * Sets the value of the '{@link maven.DistributionManagement#getDownloadUrl <em>Download Url</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see maven.MavenPackage#getDistributionManagement_Relocation()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link maven.DistributionManagement#getRelocation <em>Relocation</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see maven.MavenPackage#getDistributionManagement_Status()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link maven.DistributionManagement#getStatus <em>Status</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
