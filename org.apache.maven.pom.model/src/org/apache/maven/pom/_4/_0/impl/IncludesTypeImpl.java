 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.IncludesTypeImpl#getInclude <em>Include</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IncludesTypeImpl extends EObjectImpl implements IncludesType {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.INCLUDES_TYPE;
	}
	...
	public EList<String> getInclude() {
		if (include == null) {
			include = new EDataTypeEList<String>(String.class, this, _0Package.INCLUDES_TYPE__INCLUDE);
		}
		return include;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _0Package.INCLUDES_TYPE__INCLUDE:
				return getInclude();
		}
