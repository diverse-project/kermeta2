 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.RepositoryPolicyImpl#isEnabled <em>Enabled</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.RepositoryPolicyImpl#getUpdatePolicy <em>Update Policy</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.RepositoryPolicyImpl#getChecksumPolicy <em>Checksum Policy</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RepositoryPolicyImpl extends EObjectImpl implements RepositoryPolicy {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.REPOSITORY_POLICY;
	}
	...
	public void setEnabled(boolean newEnabled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.REPOSITORY_POLICY__ENABLED, oldEnabled, enabled, !oldEnabledESet));
	}
	...
	public void unsetEnabled() {
		...
		enabledESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _0Package.REPOSITORY_POLICY__ENABLED, oldEnabled, ENABLED_EDEFAULT, oldEnabledESet));
	}
	...
	public void setUpdatePolicy(String newUpdatePolicy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.REPOSITORY_POLICY__UPDATE_POLICY, oldUpdatePolicy, updatePolicy));
	}
	...
	public void setChecksumPolicy(String newChecksumPolicy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.REPOSITORY_POLICY__CHECKSUM_POLICY, oldChecksumPolicy, checksumPolicy));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _0Package.REPOSITORY_POLICY__ENABLED:
				return isEnabled();
			case _0Package.REPOSITORY_POLICY__UPDATE_POLICY:
				return getUpdatePolicy();
			case _0Package.REPOSITORY_POLICY__CHECKSUM_POLICY:
