 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.PluginsTypeImpl#getPlugin <em>Plugin</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PluginsTypeImpl extends EObjectImpl implements PluginsType {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.PLUGINS_TYPE;
	}
	...
	public EList<Plugin> getPlugin() {
		if (plugin == null) {
			plugin = new EObjectContainmentEList<Plugin>(Plugin.class, this, _0Package.PLUGINS_TYPE__PLUGIN);
		}
		return plugin;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.PLUGINS_TYPE__PLUGIN:
