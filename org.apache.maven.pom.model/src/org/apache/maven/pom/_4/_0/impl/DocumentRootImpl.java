 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.DocumentRootImpl#getProject <em>Project</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
	...
	public Model getProject() {
		return (Model)getMixed().get(_0Package.Literals.DOCUMENT_ROOT__PROJECT, true);
	}
	...
	public NotificationChain basicSetProject(Model newProject, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(_0Package.Literals.DOCUMENT_ROOT__PROJECT, newProject, msgs);
	}
	...
	public void setProject(Model newProject) {
		((FeatureMap.Internal)getMixed()).set(_0Package.Literals.DOCUMENT_ROOT__PROJECT, newProject);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case _0Package.DOCUMENT_ROOT__PROJECT:
