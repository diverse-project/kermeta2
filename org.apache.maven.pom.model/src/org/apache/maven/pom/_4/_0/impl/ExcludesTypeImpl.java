 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.ExcludesTypeImpl#getExclude <em>Exclude</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExcludesTypeImpl extends EObjectImpl implements ExcludesType {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.EXCLUDES_TYPE;
	}
	...
	public EList<String> getExclude() {
		if (exclude == null) {
			exclude = new EDataTypeEList<String>(String.class, this, _0Package.EXCLUDES_TYPE__EXCLUDE);
		}
		return exclude;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _0Package.EXCLUDES_TYPE__EXCLUDE:
				return getExclude();
		}
