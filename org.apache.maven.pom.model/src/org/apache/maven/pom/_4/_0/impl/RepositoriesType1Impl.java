 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.RepositoriesType1Impl#getRepository <em>Repository</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RepositoriesType1Impl extends EObjectImpl implements RepositoriesType1 {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.REPOSITORIES_TYPE1;
	}
	...
	public EList<Repository> getRepository() {
		if (repository == null) {
			repository = new EObjectContainmentEList<Repository>(Repository.class, this, _0Package.REPOSITORIES_TYPE1__REPOSITORY);
		}
		return repository;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.REPOSITORIES_TYPE1__REPOSITORY:
