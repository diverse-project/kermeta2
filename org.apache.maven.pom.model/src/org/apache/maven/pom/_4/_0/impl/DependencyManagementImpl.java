 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.DependencyManagementImpl#getDependencies <em>Dependencies</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DependencyManagementImpl extends EObjectImpl implements DependencyManagement {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.DEPENDENCY_MANAGEMENT;
	}
	...
	public NotificationChain basicSetDependencies(DependenciesType1 newDependencies, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENCY_MANAGEMENT__DEPENDENCIES, oldDependencies, newDependencies);
	...
	public void setDependencies(DependenciesType1 newDependencies) {
		if (newDependencies != dependencies) {
			...
			if (dependencies != null)
				msgs = ((InternalEObject)dependencies).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENCY_MANAGEMENT__DEPENDENCIES, null, msgs);
			if (newDependencies != null)
				msgs = ((InternalEObject)newDependencies).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.DEPENDENCY_MANAGEMENT__DEPENDENCIES, null, msgs);
			msgs = basicSetDependencies(newDependencies, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.DEPENDENCY_MANAGEMENT__DEPENDENCIES, newDependencies, newDependencies));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.DEPENDENCY_MANAGEMENT__DEPENDENCIES:
