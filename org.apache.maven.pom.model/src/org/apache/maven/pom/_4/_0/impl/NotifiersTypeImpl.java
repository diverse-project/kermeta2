 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.NotifiersTypeImpl#getNotifier <em>Notifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NotifiersTypeImpl extends EObjectImpl implements NotifiersType {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.NOTIFIERS_TYPE;
	}
	...
	public EList<Notifier> getNotifier() {
		if (notifier == null) {
			notifier = new EObjectContainmentEList<Notifier>(Notifier.class, this, _0Package.NOTIFIERS_TYPE__NOTIFIER);
		}
		return notifier;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.NOTIFIERS_TYPE__NOTIFIER:
