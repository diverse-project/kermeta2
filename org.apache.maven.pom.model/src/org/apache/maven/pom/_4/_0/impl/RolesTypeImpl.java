 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.RolesTypeImpl#getRole <em>Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RolesTypeImpl extends EObjectImpl implements RolesType {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.ROLES_TYPE;
	}
	...
	public EList<String> getRole() {
		if (role == null) {
			role = new EDataTypeEList<String>(String.class, this, _0Package.ROLES_TYPE__ROLE);
		}
		return role;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _0Package.ROLES_TYPE__ROLE:
				return getRole();
		}
