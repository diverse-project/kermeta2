 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.ReportsTypeImpl#getReport <em>Report</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReportsTypeImpl extends EObjectImpl implements ReportsType {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.REPORTS_TYPE;
	}
	...
	public EList<String> getReport() {
		if (report == null) {
			report = new EDataTypeEList<String>(String.class, this, _0Package.REPORTS_TYPE__REPORT);
		}
		return report;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _0Package.REPORTS_TYPE__REPORT:
				return getReport();
		}
