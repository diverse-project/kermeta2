 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.RepositoriesTypeImpl#getRepository <em>Repository</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RepositoriesTypeImpl extends EObjectImpl implements RepositoriesType {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.REPOSITORIES_TYPE;
	}
	...
	public EList<Repository> getRepository() {
		if (repository == null) {
			repository = new EObjectContainmentEList<Repository>(Repository.class, this, _0Package.REPOSITORIES_TYPE__REPOSITORY);
		}
		return repository;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.REPOSITORIES_TYPE__REPOSITORY:
