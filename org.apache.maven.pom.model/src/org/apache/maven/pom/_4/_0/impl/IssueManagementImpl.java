 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.IssueManagementImpl#getSystem <em>System</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.IssueManagementImpl#getUrl <em>Url</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IssueManagementImpl extends EObjectImpl implements IssueManagement {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.ISSUE_MANAGEMENT;
	}
	...
	public void setSystem(String newSystem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.ISSUE_MANAGEMENT__SYSTEM, oldSystem, system));
	}
	...
	public void setUrl(String newUrl) {
		...
		url = newUrl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.ISSUE_MANAGEMENT__URL, oldUrl, url));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _0Package.ISSUE_MANAGEMENT__SYSTEM:
				return getSystem();
			case _0Package.ISSUE_MANAGEMENT__URL:
				return getUrl();
		}
