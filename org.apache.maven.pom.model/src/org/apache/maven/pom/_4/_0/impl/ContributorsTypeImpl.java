 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.ContributorsTypeImpl#getContributor <em>Contributor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContributorsTypeImpl extends EObjectImpl implements ContributorsType {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.CONTRIBUTORS_TYPE;
	}
	...
	public EList<Contributor> getContributor() {
		if (contributor == null) {
			contributor = new EObjectContainmentEList<Contributor>(Contributor.class, this, _0Package.CONTRIBUTORS_TYPE__CONTRIBUTOR);
		}
		return contributor;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.CONTRIBUTORS_TYPE__CONTRIBUTOR:
