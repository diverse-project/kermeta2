 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.ResourcesTypeImpl#getResource <em>Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourcesTypeImpl extends EObjectImpl implements ResourcesType {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.RESOURCES_TYPE;
	}
	...
	public EList<Resource> getResource() {
		if (resource == null) {
			resource = new EObjectContainmentEList<Resource>(Resource.class, this, _0Package.RESOURCES_TYPE__RESOURCE);
		}
		return resource;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.RESOURCES_TYPE__RESOURCE:
