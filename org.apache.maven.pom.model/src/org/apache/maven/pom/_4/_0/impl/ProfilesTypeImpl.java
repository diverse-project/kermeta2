 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.ProfilesTypeImpl#getProfile <em>Profile</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProfilesTypeImpl extends EObjectImpl implements ProfilesType {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.PROFILES_TYPE;
	}
	...
	public EList<Profile> getProfile() {
		if (profile == null) {
			profile = new EObjectContainmentEList<Profile>(Profile.class, this, _0Package.PROFILES_TYPE__PROFILE);
		}
		return profile;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.PROFILES_TYPE__PROFILE:
