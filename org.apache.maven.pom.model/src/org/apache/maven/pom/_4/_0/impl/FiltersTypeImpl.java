 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.FiltersTypeImpl#getFilter <em>Filter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FiltersTypeImpl extends EObjectImpl implements FiltersType {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.FILTERS_TYPE;
	}
	...
	public EList<String> getFilter() {
		if (filter == null) {
			filter = new EDataTypeEList<String>(String.class, this, _0Package.FILTERS_TYPE__FILTER);
		}
		return filter;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _0Package.FILTERS_TYPE__FILTER:
				return getFilter();
		}
