 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildImpl#getSourceDirectory <em>Source Directory</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildImpl#getScriptSourceDirectory <em>Script Source Directory</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildImpl#getTestSourceDirectory <em>Test Source Directory</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildImpl#getOutputDirectory <em>Output Directory</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildImpl#getTestOutputDirectory <em>Test Output Directory</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildImpl#getExtensions <em>Extensions</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildImpl#getDefaultGoal <em>Default Goal</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildImpl#getResources <em>Resources</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildImpl#getTestResources <em>Test Resources</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildImpl#getDirectory <em>Directory</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildImpl#getFinalName <em>Final Name</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildImpl#getFilters <em>Filters</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildImpl#getPluginManagement <em>Plugin Management</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildImpl#getPlugins <em>Plugins</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BuildImpl extends EObjectImpl implements Build {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.BUILD;
	}
	...
	public void setSourceDirectory(String newSourceDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD__SOURCE_DIRECTORY, oldSourceDirectory, sourceDirectory));
	}
	...
	public void setScriptSourceDirectory(String newScriptSourceDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD__SCRIPT_SOURCE_DIRECTORY, oldScriptSourceDirectory, scriptSourceDirectory));
	}
	...
	public void setTestSourceDirectory(String newTestSourceDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD__TEST_SOURCE_DIRECTORY, oldTestSourceDirectory, testSourceDirectory));
	}
	...
	public void setOutputDirectory(String newOutputDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD__OUTPUT_DIRECTORY, oldOutputDirectory, outputDirectory));
	}
	...
	public void setTestOutputDirectory(String newTestOutputDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD__TEST_OUTPUT_DIRECTORY, oldTestOutputDirectory, testOutputDirectory));
	}
	...
	public NotificationChain basicSetExtensions(ExtensionsType newExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.BUILD__EXTENSIONS, oldExtensions, newExtensions);
	...
	public void setExtensions(ExtensionsType newExtensions) {
		if (newExtensions != extensions) {
			...
			if (extensions != null)
				msgs = ((InternalEObject)extensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD__EXTENSIONS, null, msgs);
			if (newExtensions != null)
				msgs = ((InternalEObject)newExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD__EXTENSIONS, null, msgs);
			msgs = basicSetExtensions(newExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD__EXTENSIONS, newExtensions, newExtensions));
	}
	...
	public void setDefaultGoal(String newDefaultGoal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD__DEFAULT_GOAL, oldDefaultGoal, defaultGoal));
	}
	...
	public NotificationChain basicSetResources(ResourcesType1 newResources, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.BUILD__RESOURCES, oldResources, newResources);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setResources(ResourcesType1 newResources) {
		if (newResources != resources) {
			NotificationChain msgs = null;
			if (resources != null)
				msgs = ((InternalEObject)resources).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD__RESOURCES, null, msgs);
			if (newResources != null)
				msgs = ((InternalEObject)newResources).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD__RESOURCES, null, msgs);
			msgs = basicSetResources(newResources, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD__RESOURCES, newResources, newResources));
	}
	...
	public NotificationChain basicSetTestResources(TestResourcesType1 newTestResources, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.BUILD__TEST_RESOURCES, oldTestResources, newTestResources);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTestResources(TestResourcesType1 newTestResources) {
		if (newTestResources != testResources) {
			...
			if (testResources != null)
				msgs = ((InternalEObject)testResources).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD__TEST_RESOURCES, null, msgs);
			if (newTestResources != null)
				msgs = ((InternalEObject)newTestResources).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD__TEST_RESOURCES, null, msgs);
			msgs = basicSetTestResources(newTestResources, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD__TEST_RESOURCES, newTestResources, newTestResources));
	}
	...
	public void setDirectory(String newDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD__DIRECTORY, oldDirectory, directory));
	}
	...
	public void setFinalName(String newFinalName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD__FINAL_NAME, oldFinalName, finalName));
	}
	...
	public NotificationChain basicSetFilters(FiltersType1 newFilters, NotificationChain msgs) {
		...
		filters = newFilters;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.BUILD__FILTERS, oldFilters, newFilters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFilters(FiltersType1 newFilters) {
		if (newFilters != filters) {
			NotificationChain msgs = null;
			if (filters != null)
				msgs = ((InternalEObject)filters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD__FILTERS, null, msgs);
			if (newFilters != null)
				msgs = ((InternalEObject)newFilters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD__FILTERS, null, msgs);
			msgs = basicSetFilters(newFilters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD__FILTERS, newFilters, newFilters));
	}
	...
	public NotificationChain basicSetPluginManagement(PluginManagement newPluginManagement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.BUILD__PLUGIN_MANAGEMENT, oldPluginManagement, newPluginManagement);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPluginManagement(PluginManagement newPluginManagement) {
		if (newPluginManagement != pluginManagement) {
			...
			if (pluginManagement != null)
				msgs = ((InternalEObject)pluginManagement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD__PLUGIN_MANAGEMENT, null, msgs);
			if (newPluginManagement != null)
				msgs = ((InternalEObject)newPluginManagement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD__PLUGIN_MANAGEMENT, null, msgs);
			msgs = basicSetPluginManagement(newPluginManagement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD__PLUGIN_MANAGEMENT, newPluginManagement, newPluginManagement));
	}
	...
	public NotificationChain basicSetPlugins(PluginsType2 newPlugins, NotificationChain msgs) {
		...
		plugins = newPlugins;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.BUILD__PLUGINS, oldPlugins, newPlugins);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPlugins(PluginsType2 newPlugins) {
		if (newPlugins != plugins) {
			NotificationChain msgs = null;
			if (plugins != null)
				msgs = ((InternalEObject)plugins).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD__PLUGINS, null, msgs);
			if (newPlugins != null)
				msgs = ((InternalEObject)newPlugins).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD__PLUGINS, null, msgs);
			msgs = basicSetPlugins(newPlugins, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD__PLUGINS, newPlugins, newPlugins));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.BUILD__EXTENSIONS:
				return basicSetExtensions(null, msgs);
			case _0Package.BUILD__RESOURCES:
				return basicSetResources(null, msgs);
			case _0Package.BUILD__TEST_RESOURCES:
				return basicSetTestResources(null, msgs);
			case _0Package.BUILD__FILTERS:
				return basicSetFilters(null, msgs);
			case _0Package.BUILD__PLUGIN_MANAGEMENT:
				return basicSetPluginManagement(null, msgs);
			case _0Package.BUILD__PLUGINS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _0Package.BUILD__SOURCE_DIRECTORY:
				return getSourceDirectory();
			case _0Package.BUILD__SCRIPT_SOURCE_DIRECTORY:
				return getScriptSourceDirectory();
			case _0Package.BUILD__TEST_SOURCE_DIRECTORY:
				return getTestSourceDirectory();
			case _0Package.BUILD__OUTPUT_DIRECTORY:
				return getOutputDirectory();
			case _0Package.BUILD__TEST_OUTPUT_DIRECTORY:
				return getTestOutputDirectory();
			case _0Package.BUILD__EXTENSIONS:
				return getExtensions();
			case _0Package.BUILD__DEFAULT_GOAL:
				return getDefaultGoal();
			case _0Package.BUILD__RESOURCES:
				return getResources();
			case _0Package.BUILD__TEST_RESOURCES:
				return getTestResources();
			case _0Package.BUILD__DIRECTORY:
				return getDirectory();
			case _0Package.BUILD__FINAL_NAME:
				return getFinalName();
			case _0Package.BUILD__FILTERS:
				return getFilters();
			case _0Package.BUILD__PLUGIN_MANAGEMENT:
