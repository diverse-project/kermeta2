 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildBaseImpl#getDefaultGoal <em>Default Goal</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildBaseImpl#getResources <em>Resources</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildBaseImpl#getTestResources <em>Test Resources</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildBaseImpl#getDirectory <em>Directory</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildBaseImpl#getFinalName <em>Final Name</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildBaseImpl#getFilters <em>Filters</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildBaseImpl#getPluginManagement <em>Plugin Management</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.BuildBaseImpl#getPlugins <em>Plugins</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BuildBaseImpl extends EObjectImpl implements BuildBase {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.BUILD_BASE;
	}
	...
	public void setDefaultGoal(String newDefaultGoal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD_BASE__DEFAULT_GOAL, oldDefaultGoal, defaultGoal));
	}
	...
	public NotificationChain basicSetResources(ResourcesType newResources, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.BUILD_BASE__RESOURCES, oldResources, newResources);
	...
	public void setResources(ResourcesType newResources) {
		if (newResources != resources) {
			...
			if (resources != null)
				msgs = ((InternalEObject)resources).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD_BASE__RESOURCES, null, msgs);
			if (newResources != null)
				msgs = ((InternalEObject)newResources).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD_BASE__RESOURCES, null, msgs);
			msgs = basicSetResources(newResources, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD_BASE__RESOURCES, newResources, newResources));
	}
	...
	public NotificationChain basicSetTestResources(TestResourcesType newTestResources, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.BUILD_BASE__TEST_RESOURCES, oldTestResources, newTestResources);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTestResources(TestResourcesType newTestResources) {
		if (newTestResources != testResources) {
			...
			if (testResources != null)
				msgs = ((InternalEObject)testResources).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD_BASE__TEST_RESOURCES, null, msgs);
			if (newTestResources != null)
				msgs = ((InternalEObject)newTestResources).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD_BASE__TEST_RESOURCES, null, msgs);
			msgs = basicSetTestResources(newTestResources, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD_BASE__TEST_RESOURCES, newTestResources, newTestResources));
	}
	...
	public void setDirectory(String newDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD_BASE__DIRECTORY, oldDirectory, directory));
	}
	...
	public void setFinalName(String newFinalName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD_BASE__FINAL_NAME, oldFinalName, finalName));
	}
	...
	public NotificationChain basicSetFilters(FiltersType newFilters, NotificationChain msgs) {
		...
		filters = newFilters;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.BUILD_BASE__FILTERS, oldFilters, newFilters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFilters(FiltersType newFilters) {
		if (newFilters != filters) {
			NotificationChain msgs = null;
			if (filters != null)
				msgs = ((InternalEObject)filters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD_BASE__FILTERS, null, msgs);
			if (newFilters != null)
				msgs = ((InternalEObject)newFilters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD_BASE__FILTERS, null, msgs);
			msgs = basicSetFilters(newFilters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD_BASE__FILTERS, newFilters, newFilters));
	}
	...
	public NotificationChain basicSetPluginManagement(PluginManagement newPluginManagement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.BUILD_BASE__PLUGIN_MANAGEMENT, oldPluginManagement, newPluginManagement);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPluginManagement(PluginManagement newPluginManagement) {
		if (newPluginManagement != pluginManagement) {
			...
			if (pluginManagement != null)
				msgs = ((InternalEObject)pluginManagement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD_BASE__PLUGIN_MANAGEMENT, null, msgs);
			if (newPluginManagement != null)
				msgs = ((InternalEObject)newPluginManagement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD_BASE__PLUGIN_MANAGEMENT, null, msgs);
			msgs = basicSetPluginManagement(newPluginManagement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD_BASE__PLUGIN_MANAGEMENT, newPluginManagement, newPluginManagement));
	}
	...
	public NotificationChain basicSetPlugins(PluginsType newPlugins, NotificationChain msgs) {
		...
		plugins = newPlugins;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.BUILD_BASE__PLUGINS, oldPlugins, newPlugins);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPlugins(PluginsType newPlugins) {
		if (newPlugins != plugins) {
			NotificationChain msgs = null;
			if (plugins != null)
				msgs = ((InternalEObject)plugins).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD_BASE__PLUGINS, null, msgs);
			if (newPlugins != null)
				msgs = ((InternalEObject)newPlugins).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.BUILD_BASE__PLUGINS, null, msgs);
			msgs = basicSetPlugins(newPlugins, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.BUILD_BASE__PLUGINS, newPlugins, newPlugins));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.BUILD_BASE__RESOURCES:
				return basicSetResources(null, msgs);
			case _0Package.BUILD_BASE__TEST_RESOURCES:
				return basicSetTestResources(null, msgs);
			case _0Package.BUILD_BASE__FILTERS:
				return basicSetFilters(null, msgs);
			case _0Package.BUILD_BASE__PLUGIN_MANAGEMENT:
				return basicSetPluginManagement(null, msgs);
			case _0Package.BUILD_BASE__PLUGINS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _0Package.BUILD_BASE__DEFAULT_GOAL:
				return getDefaultGoal();
			case _0Package.BUILD_BASE__RESOURCES:
				return getResources();
			case _0Package.BUILD_BASE__TEST_RESOURCES:
				return getTestResources();
			case _0Package.BUILD_BASE__DIRECTORY:
				return getDirectory();
			case _0Package.BUILD_BASE__FINAL_NAME:
				return getFinalName();
			case _0Package.BUILD_BASE__FILTERS:
				return getFilters();
			case _0Package.BUILD_BASE__PLUGIN_MANAGEMENT:
