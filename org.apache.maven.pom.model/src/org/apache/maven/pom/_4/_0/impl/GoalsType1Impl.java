 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.GoalsType1Impl#getGoal <em>Goal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GoalsType1Impl extends EObjectImpl implements GoalsType1 {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.GOALS_TYPE1;
	}
	...
	public EList<String> getGoal() {
		if (goal == null) {
			goal = new EDataTypeEList<String>(String.class, this, _0Package.GOALS_TYPE1__GOAL);
		}
		return goal;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _0Package.GOALS_TYPE1__GOAL:
				return getGoal();
		}
