 ...
 * <ul>
 *   <li>{@link org.apache.maven.pom._4._0.impl.CiManagementImpl#getSystem <em>System</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.CiManagementImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link org.apache.maven.pom._4._0.impl.CiManagementImpl#getNotifiers <em>Notifiers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CiManagementImpl extends EObjectImpl implements CiManagement {
	...
	protected EClass eStaticClass() {
		return _0Package.Literals.CI_MANAGEMENT;
	}
	...
	public void setSystem(String newSystem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.CI_MANAGEMENT__SYSTEM, oldSystem, system));
	}
	...
	public void setUrl(String newUrl) {
		...
		url = newUrl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.CI_MANAGEMENT__URL, oldUrl, url));
	}
	...
	public NotificationChain basicSetNotifiers(NotifiersType newNotifiers, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _0Package.CI_MANAGEMENT__NOTIFIERS, oldNotifiers, newNotifiers);
	...
	public void setNotifiers(NotifiersType newNotifiers) {
		if (newNotifiers != notifiers) {
			...
			if (notifiers != null)
				msgs = ((InternalEObject)notifiers).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _0Package.CI_MANAGEMENT__NOTIFIERS, null, msgs);
			if (newNotifiers != null)
				msgs = ((InternalEObject)newNotifiers).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _0Package.CI_MANAGEMENT__NOTIFIERS, null, msgs);
			msgs = basicSetNotifiers(newNotifiers, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _0Package.CI_MANAGEMENT__NOTIFIERS, newNotifiers, newNotifiers));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _0Package.CI_MANAGEMENT__NOTIFIERS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _0Package.CI_MANAGEMENT__SYSTEM:
				return getSystem();
			case _0Package.CI_MANAGEMENT__URL:
				return getUrl();
			case _0Package.CI_MANAGEMENT__NOTIFIERS:
				return getNotifiers();
		}
