...
public interface StructurePackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://www.kermeta.org/kermeta/2_0_0//kermeta/language/structure";
	 ...
	 * @ordered
	 */
	int OPERATION__OWNING_CLASS = MULTIPLICITY_ELEMENT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int OPERATION__TYPE_PARAMETER = MULTIPLICITY_ELEMENT_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int OPERATION__OWNED_PARAMETER = MULTIPLICITY_ELEMENT_FEATURE_COUNT + 8;
	 ...
	 * @ordered
	 */
	int CLASS_DEFINITION__OWNED_TAGS = TYPE_CONTAINER__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int CLASS_DEFINITION__IS_ASPECT = TYPE_CONTAINER_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int CLASS_DEFINITION__TYPE_PARAMETER = TYPE_CONTAINER_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int CLASS_DEFINITION__INV = TYPE_CONTAINER_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int CLASS_DEFINITION__IS_ABSTRACT = TYPE_CONTAINER_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int CLASS_DEFINITION__OWNED_ATTRIBUTE = TYPE_CONTAINER_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int CLASS_DEFINITION__OWNED_OPERATION = TYPE_CONTAINER_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int CLASS_DEFINITION__SUPER_TYPE = TYPE_CONTAINER_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int CLASS_DEFINITION_FEATURE_COUNT = TYPE_CONTAINER_FEATURE_COUNT + 8;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE__TAG = TYPE_CONTAINER__TAG;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE__OWNED_TAGS = TYPE_CONTAINER__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE__CONTAINED_TYPE = TYPE_CONTAINER__CONTAINED_TYPE;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE__NAME = TYPE_CONTAINER_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE__IS_ASPECT = TYPE_CONTAINER_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE__TYPE_CONTAINER = TYPE_CONTAINER_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE__INSTANCE_TYPE = TYPE_CONTAINER_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int PRIMITIVE_TYPE_FEATURE_COUNT = TYPE_CONTAINER_FEATURE_COUNT + 4;
	 ...
	 * @generated
	 */
	int TYPE_DEFINITION_CONTAINER = 24;
	 ...
	 * @ordered
	 */
	int DATA_TYPE__OWNED_TAGS = TYPE_DEFINITION__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int UNRESOLVED_TYPE__TAG = TYPE__TAG;
	 ...
	 * @ordered
	 */
	int UNRESOLVED_TYPE__OWNED_TAGS = TYPE__OWNED_TAGS;
	 ...
	 * @ordered
	 */
	int TAG__OBJECT = OBJECT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TAG__NAME = OBJECT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int TAG__VALUE = OBJECT_FEATURE_COUNT + 2;
	...
	/**
	 * Returns the meta object for the reference list '{@link org.kermeta.language.structure.Object#getTag <em>Tag</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link org.kermeta.language.structure.Object#getOwnedTags <em>Owned Tags</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Owned Tags</em>'.
	 * @see org.kermeta.language.structure.Object#getOwnedTags()
	 * @see #getObject()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference list '{@link org.kermeta.language.structure.ClassDefinition#getSuperType <em>Super Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Super Type</em>'.
	 * @see org.kermeta.language.structure.ClassDefinition#getSuperType()
	 * @see #getClassDefinition()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference list '{@link org.kermeta.language.structure.ModelingUnit#getUsings <em>Usings</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Usings</em>'.
	 * @see org.kermeta.language.structure.ModelingUnit#getUsings()
	 * @see #getModelingUnit()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference list '{@link org.kermeta.language.structure.ModelType#getIncludedTypeDefinition <em>Included Type Definition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Included Type Definition</em>'.
	 * @see org.kermeta.language.structure.ModelType#getIncludedTypeDefinition()
	 * @see #getModelType()
	 * @generated
	 */
