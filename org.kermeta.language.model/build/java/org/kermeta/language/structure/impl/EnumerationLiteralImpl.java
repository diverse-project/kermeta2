 ...
 * <ul>
 *   <li>{@link org.kermeta.language.structure.impl.EnumerationLiteralImpl#getEnumeration <em>Enumeration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumerationLiteralImpl extends NamedElementImpl implements EnumerationLiteral {
	...
	public void setEnumeration(Enumeration newEnumeration) {
		if (newEnumeration != eInternalContainer() || (eContainerFeatureID() != StructurePackage.ENUMERATION_LITERAL__ENUMERATION && newEnumeration != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StructurePackage.ENUMERATION_LITERAL__ENUMERATION, newEnumeration, newEnumeration));
	}
