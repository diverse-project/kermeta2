...
public class TypeMappingImpl extends ObjectImpl implements TypeMapping {
	...
	public EObject getMapping() {
		if (mapping != null && mapping.eIsProxy()) {
			...
			mapping = eResolveProxy(oldMapping);
			if (mapping != oldMapping) {
				InternalEObject newMapping = (InternalEObject)mapping;
				NotificationChain msgs = oldMapping.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StructurePackage.TYPE_MAPPING__MAPPING, null, null);
				if (newMapping.eInternalContainer() == null) {
					msgs = newMapping.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StructurePackage.TYPE_MAPPING__MAPPING, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StructurePackage.TYPE_MAPPING__MAPPING, oldMapping, mapping));
			}
		}
		return mapping;
	}
	 ...
	 * @generated
	 */
	public EObject basicGetMapping() {
		return mapping;
	}
	 ...
	 * @generated
	 */
	public TypeDefinition basicGetSourceType() {
		if (eContainerFeatureID() != StructurePackage.TYPE_MAPPING__SOURCE_TYPE) return null;
