 ...
 * <ul>
 *   <li>{@link org.kermeta.language.structure.impl.ResourceGroupImpl#getResources <em>Resources</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceGroupImpl extends ResourceImpl implements ResourceGroup {
	...
	protected EClass eStaticClass() {
		return StructurePackage.Literals.RESOURCE_GROUP;
	}
	...
	public EList<Resource> getResources() {
		if (resources == null) {
			resources = new EObjectResolvingEList<Resource>(Resource.class, this, StructurePackage.RESOURCE_GROUP__RESOURCES);
		}
		return resources;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StructurePackage.RESOURCE_GROUP__RESOURCES:
				return getResources();
		}
