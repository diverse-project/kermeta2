...
public class PackageImpl extends NamedElementImpl implements org.kermeta.language.structure.Package {
	...
	public EList<org.kermeta.language.structure.Package> getNestedPackage() {
		if (nestedPackage == null) {
			nestedPackage = new EObjectContainmentWithInverseEList.Resolving<org.kermeta.language.structure.Package>(org.kermeta.language.structure.Package.class, this, StructurePackage.PACKAGE__NESTED_PACKAGE, StructurePackage.PACKAGE__NESTING_PACKAGE);
		}
	 ...
	 * @generated
	 */
	public org.kermeta.language.structure.Package basicGetNestingPackage() {
		if (eContainerFeatureID() != StructurePackage.PACKAGE__NESTING_PACKAGE) return null;
		return (org.kermeta.language.structure.Package)eInternalContainer();
	}
