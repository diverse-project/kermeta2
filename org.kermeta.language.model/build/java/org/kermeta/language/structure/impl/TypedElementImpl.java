 ...
 * <ul>
 *   <li>{@link org.kermeta.language.structure.impl.TypedElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.kermeta.language.structure.impl.TypedElementImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TypedElementImpl extends TypeContainerImpl implements TypedElement {
	...
	public Type getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StructurePackage.TYPED_ELEMENT__TYPE, oldType, type));
			}
		}
		return type;
	}
