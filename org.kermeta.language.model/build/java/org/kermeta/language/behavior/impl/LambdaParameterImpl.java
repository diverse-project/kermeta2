 ...
 * <ul>
 *   <li>{@link org.kermeta.language.behavior.impl.LambdaParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.kermeta.language.behavior.impl.LambdaParameterImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LambdaParameterImpl extends ObjectImpl implements LambdaParameter {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviorPackage.LAMBDA_PARAMETER__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetType(TypeReference newType, NotificationChain msgs) {
		...
		type = newType;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BehaviorPackage.LAMBDA_PARAMETER__TYPE, oldType, newType);
	...
	public void setType(TypeReference newType) {
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BehaviorPackage.LAMBDA_PARAMETER__TYPE, null, msgs);
			if (newType != null)
				msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BehaviorPackage.LAMBDA_PARAMETER__TYPE, null, msgs);
			msgs = basicSetType(newType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviorPackage.LAMBDA_PARAMETER__TYPE, newType, newType));
	}
