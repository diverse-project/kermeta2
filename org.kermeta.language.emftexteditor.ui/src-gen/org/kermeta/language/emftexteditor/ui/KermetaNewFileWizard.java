...
public class KermetaNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	public boolean performFinish() {
		...
		try {
			...
			org.kermeta.language.emftexteditor.ui.KermetaUIPlugin.logError("java.lang.Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.kermeta.language.emftexteditor.ui.KermetaUIPlugin.logError("java.lang.Exception while initializing new file", e);
			return false;
		}
		return true;
	}
