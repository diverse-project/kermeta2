 ...
 * olInput</code>.
 */
public class KermetaDocBrowserInformationControlInput {
	
	private final KermetaDocBrowserInformationControlInput fPrevious;
	private KermetaDocBrowserInformationControlInput fNext;
	 ...
	 */
	public KermetaDocBrowserInformationControlInput(KermetaDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public KermetaDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public KermetaDocBrowserInformationControlInput getNext() {
		return fNext;
	}
