 ...
 */
public class KermetaPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(org.kermeta.language.emftexteditor.ui.KermetaUIPlugin.getDefault().getPreferenceStore());
		setDescription(" Kermeta Text Editor Preferences");
	}
