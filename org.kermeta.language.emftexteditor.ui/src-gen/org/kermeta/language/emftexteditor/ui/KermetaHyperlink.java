 ...
 */
public class KermetaHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public KermetaHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof org.kermeta.language.emftexteditor.ui.KermetaEditor) {
					org.kermeta.language.emftexteditor.ui.KermetaEditor emftEditor = (org.kermeta.language.emftexteditor.ui.KermetaEditor) editorPart;
