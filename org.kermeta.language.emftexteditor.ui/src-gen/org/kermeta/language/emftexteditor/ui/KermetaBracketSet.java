 ...
 */
public class KermetaBracketSet {
	...
	private java.util.ArrayList<org.kermeta.language.emftexteditor.IKermetaBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.kermeta.language.emftexteditor.IKermetaBracketPair {
	 ...
	 */
	private class ClosingListener implements org.kermeta.language.emftexteditor.ui.IKermetaBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.kermeta.language.emftexteditor.IKermetaBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public KermetaBracketSet(org.kermeta.language.emftexteditor.ui.KermetaEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.kermeta.language.emftexteditor.mopp.KermetaMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.kermeta.language.emftexteditor.IKermetaBracketPair>();
	 ...
	 */
	public org.kermeta.language.emftexteditor.IKermetaBracketPair getBracketPair(String opening, String closing) {
		for (org.kermeta.language.emftexteditor.IKermetaBracketPair bracketPair : bracketPairs) {
	...
	public org.kermeta.language.emftexteditor.IKermetaBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.kermeta.language.emftexteditor.IKermetaBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.kermeta.language.emftexteditor.ui.KermetaPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.kermeta.language.emftexteditor.IKermetaBracketPair remove(String opening, String closing) {
		for (org.kermeta.language.emftexteditor.IKermetaBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.kermeta.language.emftexteditor.IKermetaBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.kermeta.language.emftexteditor.ui.KermetaPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.kermeta.language.emftexteditor.ui.KermetaPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
