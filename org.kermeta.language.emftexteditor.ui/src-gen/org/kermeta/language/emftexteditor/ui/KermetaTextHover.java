 ...
 */
public class KermetaTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private org.kermeta.language.emftexteditor.IKermetaHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.kermeta.language.emftexteditor.ui.KermetaBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.kermeta.language.emftexteditor.ui.KermetaBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.kermeta.language.emftexteditor.ui.KermetaDocBrowserInformationControlInput infoInput = (org.kermeta.language.emftexteditor.ui.KermetaDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.kermeta.language.emftexteditor.ui.KermetaHyperlink hyperlink = new org.kermeta.language.emftexteditor.ui.KermetaHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.kermeta.language.emftexteditor.ui.KermetaBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.kermeta.language.emftexteditor.ui.KermetaBrowserInformationControl iControl = new org.kermeta.language.emftexteditor.ui.KermetaBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(java.lang.Object newInput) {
						...
						} else if (newInput instanceof org.kermeta.language.emftexteditor.ui.KermetaDocBrowserInformationControlInput) {
							org.kermeta.language.emftexteditor.ui.KermetaDocBrowserInformationControlInput input = (org.kermeta.language.emftexteditor.ui.KermetaDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.kermeta.language.emftexteditor.ui.KermetaBrowserInformationControl.isAvailable(parent)) {
				org.kermeta.language.emftexteditor.ui.KermetaBrowserInformationControl iControl = new org.kermeta.language.emftexteditor.ui.KermetaBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public KermetaTextHover(org.kermeta.language.emftexteditor.ui.KermetaEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new org.kermeta.language.emftexteditor.ui.KermetaUIMetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.kermeta.language.emftexteditor.ui.KermetaDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.kermeta.language.emftexteditor.ui.KermetaDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.kermeta.language.emftexteditor.IKermetaTextResource textResource = editor.getResource();
	 ...
	 */
	private org.kermeta.language.emftexteditor.ui.KermetaDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.kermeta.language.emftexteditor.ui.KermetaDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.kermeta.language.emftexteditor.ui.KermetaHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			org.kermeta.language.emftexteditor.ui.KermetaHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.kermeta.language.emftexteditor.ui.KermetaHTMLPrinter.insertPageProlog(buffer, 0, org.kermeta.language.emftexteditor.ui.KermetaTextHover.getStyleSheet());
			org.kermeta.language.emftexteditor.ui.KermetaHTMLPrinter.addPageEpilog(buffer);
			return new org.kermeta.language.emftexteditor.ui.KermetaDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.kermeta.language.emftexteditor.ui.KermetaHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.kermeta.language.emftexteditor.ui.KermetaUIPlugin.PLUGIN_ID);
