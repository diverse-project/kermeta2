 ...
 */
public class KermetaNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public KermetaNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new kermeta file");
