...
/**
 * A text editor for 'kermeta' models.
 */
public class KermetaEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	
	private org.kermeta.language.emftexteditor.ui.KermetaHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.kermeta.language.emftexteditor.ui.KermetaCodeFoldingManager codeFoldingManager;
	private org.kermeta.language.emftexteditor.ui.KermetaBackgroundParsingStrategy bgParsingStrategy = new org.kermeta.language.emftexteditor.ui.KermetaBackgroundParsingStrategy();
	private java.util.Collection<org.kermeta.language.emftexteditor.IKermetaBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.kermeta.language.emftexteditor.IKermetaBackgroundParsingListener>();
	private org.kermeta.language.emftexteditor.ui.KermetaColorManager colorManager = new org.kermeta.language.emftexteditor.ui.KermetaColorManager();
	private org.kermeta.language.emftexteditor.ui.KermetaOutlinePage outlinePage;
	...
	private org.kermeta.language.emftexteditor.ui.KermetaPropertySheetPage propertySheetPage;
	...
	private org.kermeta.language.emftexteditor.ui.IKermetaBracketHandler bracketHandler;
	
	public KermetaEditor() {
		super();
		setDocumentProvider(new org.eclipse.ui.editors.text.FileDocumentProvider());
		setSourceViewerConfiguration(new org.kermeta.language.emftexteditor.ui.KermetaEditorConfiguration(this, colorManager));
	...
	private final class MarkerUpdateListener implements org.kermeta.language.emftexteditor.IKermetaBackgroundParsingListener {
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), KermetaEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.kermeta.language.emftexteditor.IKermetaTextResource currentResource = getResource();
				...
				org.kermeta.language.emftexteditor.ui.KermetaUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.kermeta.language.emftexteditor.EditorContext");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.kermeta.language.emftexteditor.ui.KermetaHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.kermeta.language.emftexteditor.ui.KermetaCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.kermeta.language.emftexteditor.mopp.KermetaNature.activate(inputFile.getProject());
		...
		org.kermeta.language.emftexteditor.IKermetaTextResource loadedResource = (org.kermeta.language.emftexteditor.IKermetaTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.kermeta.language.emftexteditor.IKermetaTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.kermeta.language.emftexteditor.IKermetaTextResource) {
					setResource((org.kermeta.language.emftexteditor.IKermetaTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.kermeta.language.emftexteditor.ui.KermetaUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the KermetaEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				org.kermeta.language.emftexteditor.ui.KermetaUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.kermeta.language.emftexteditor.IKermetaTextResource resource) {
		assert resource != null;
	...
	private java.lang.Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.kermeta.language.emftexteditor.ui.KermetaOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.kermeta.language.emftexteditor.ui.KermetaPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.kermeta.language.emftexteditor.IKermetaTextResource textResource = (org.kermeta.language.emftexteditor.IKermetaTextResource) element.eResource();
			...
			org.kermeta.language.emftexteditor.IKermetaTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.kermeta.language.emftexteditor.IKermetaTextToken token = lexer.getNextToken();
			...
			org.kermeta.language.emftexteditor.ui.KermetaUIPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(org.kermeta.language.emftexteditor.IKermetaBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.kermeta.language.emftexteditor.IKermetaBackgroundParsingListener listener : bgParsingListeners) {
	...
	private void refreshMarkers(final org.eclipse.emf.ecore.resource.Resource resourceToRefresh) {
		...
		if (display != null) {
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						org.kermeta.language.emftexteditor.ui.KermetaMarkerHelper.unmark(resourceToRefresh);
						org.kermeta.language.emftexteditor.ui.KermetaMarkerHelper.mark(resourceToRefresh);
					} catch (org.eclipse.core.runtime.CoreException e) {
						org.kermeta.language.emftexteditor.ui.KermetaUIPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}
	...
	public org.kermeta.language.emftexteditor.ui.IKermetaBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.kermeta.language.emftexteditor.ui.IKermetaBracketHandler bracketHandler) {
